...
# direct methods
.method constructor <init>(Lj$/time/temporal/k;)V
    .locals 3
    ...
    invoke-virtual {v0}, Lj$/time/temporal/v;->f()Z
...
.method public final a(Lj$/time/format/r;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0}, Lj$/time/temporal/k;->a()Lj$/time/temporal/v;

    move-result-object v0

    iget-object v4, p0, Lj$/time/format/h;->a:Lj$/time/temporal/k;

    invoke-virtual {v0, v2, v3, v4}, Lj$/time/temporal/v;->b(JLj$/time/temporal/k;)J

    invoke-virtual {v0}, Lj$/time/temporal/v;->e()J
