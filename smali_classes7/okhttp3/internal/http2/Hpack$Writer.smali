...
.field private final out:Lmt0/c;
...
# direct methods
.method public constructor <init>(ILmt0/c;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLmt0/c;ILep0/k;)V

    return-void
.end method

.method public constructor <init>(IZLmt0/c;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lmt0/c;
...
.method public synthetic constructor <init>(IZLmt0/c;ILep0/k;)V
    .locals 0
    ...
    .line 6
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLmt0/c;)V
...
.method public final writeByteString(Lmt0/f;)V
    .locals 4
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lmt0/f;)I
    ...
    .line 4
    invoke-virtual {v0, p1, v2}, Lokhttp3/internal/http2/Huffman;->encode(Lmt0/f;Lmt0/d;)V

    .line 5
    invoke-virtual {v2}, Lmt0/c;->j0()Lmt0/f;
    ...
    .line 8
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lmt0/c;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lmt0/f;

    invoke-virtual {v4}, Lmt0/f;->w()Lmt0/f;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lmt0/f;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Lmt0/f;
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Header;->value:Lmt0/f;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lmt0/f;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lmt0/f;
    ...
    .line 21
    iget-object v6, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lmt0/c;

    invoke-virtual {v6, v7}, Lmt0/c;->M(I)Lmt0/c;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lmt0/f;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lmt0/f;)V
    ...
    .line 25
    :cond_a
    sget-object v8, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lmt0/f;

    invoke-virtual {v4, v8}, Lmt0/f;->t(Lmt0/f;)Z

    move-result v8

    if-eqz v8, :cond_b

    sget-object v8, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lmt0/f;
...
.method public final writeInt(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lmt0/c;
