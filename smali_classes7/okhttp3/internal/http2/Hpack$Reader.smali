...
# direct methods
.method public constructor <init>(Lmt0/h0;I)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lmt0/h0;IIILep0/k;)V

    return-void
.end method

.method public constructor <init>(Lmt0/h0;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lmt0/e;
...
.method public synthetic constructor <init>(Lmt0/h0;IIILep0/k;)V
    .locals 0
    ...
    .line 6
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lmt0/h0;II)V
...
.method private final getName(I)Lmt0/f;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lmt0/f;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lmt0/e;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lmt0/f;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lmt0/f;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lmt0/f;Lmt0/f;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lmt0/f;)Lmt0/f;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lmt0/f;Lmt0/f;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lmt0/f;Lmt0/f;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lmt0/f;Lmt0/f;)V
...
.method public final readByteString()Lmt0/f;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lmt0/e;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lmt0/e;JLmt0/d;)V
    ...
    invoke-interface {v0, v2, v3}, Lmt0/e;->V(J)Lmt0/f;
