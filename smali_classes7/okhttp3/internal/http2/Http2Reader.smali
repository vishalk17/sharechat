...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lep0/k;)V
...
.method public constructor <init>(Lmt0/e;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lmt0/e;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lmt0/h0;IIILep0/k;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;

    invoke-interface {v1}, Lmt0/e;->readByte()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILmt0/e;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;
    ...
    invoke-interface {v0, v1, v2}, Lmt0/e;->V(J)Lmt0/f;

    move-result-object v0

    .line 6
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lmt0/f;)V
    ...
    .line 12
    invoke-static {p3, p2}, Landroid/support/v4/media/a;->b(Ljava/lang/String;I)Ljava/lang/String;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 13
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p3, p2, p4}, Ld50/d;->k(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lkp0/n;->l(II)Lkp0/i;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lkp0/n;->k(Lkp0/g;I)Lkp0/g;

    move-result-object p2

    .line 6
    iget v1, p2, Lkp0/g;->b:I

    .line 7
    iget v2, p2, Lkp0/g;->c:I

    .line 8
    iget p2, p2, Lkp0/g;->d:I
    ...
    invoke-interface {v3}, Lmt0/e;->readShort()S
    ...
    .line 10
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmt0/e;

    invoke-interface {v4}, Lmt0/e;->readInt()I
    ...
    .line 12
    invoke-static {p2, v4}, Landroid/support/v4/media/a;->b(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lmt0/e;)I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lmt0/f;
    ...
    .line 6
    invoke-interface {p1, v2, v3}, Lmt0/e;->V(J)Lmt0/f;
    ...
    .line 13
    invoke-virtual {p1}, Lmt0/f;->y()Ljava/lang/String;
