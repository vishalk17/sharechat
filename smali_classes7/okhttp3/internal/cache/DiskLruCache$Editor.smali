...
.method public final newSink(I)Lmt0/f0;
    .locals 4
    ...
    .line 4
    new-instance p1, Lmt0/b;

    invoke-direct {p1}, Lmt0/b;-><init>()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v2, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lmt0/f0;
    ...
    invoke-direct {v2, v1, v3}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(Lmt0/f0;Ldp0/l;)V
    :try_end_3
...
.method public final newSource(I)Lmt0/h0;
    .locals 4
    ...
    invoke-interface {v1, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lmt0/h0;
