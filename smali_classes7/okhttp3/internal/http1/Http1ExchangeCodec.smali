...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sink",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lmt0/e;Lmt0/d;)V",
        "Companion",
        "AbstractSource",
        "ChunkedSink",
        "ChunkedSource",
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(Lep0/k;)V
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lmt0/e;Lmt0/d;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lmt0/e;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lmt0/d;

    .line 2
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lmt0/e;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lmt0/n;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lmt0/n;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lmt0/d;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lmt0/d;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lmt0/e;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lmt0/e;
...
.method private final detachTimeout(Lmt0/n;)V
    .locals 3

    .line 1
    iget-object v0, p1, Lmt0/n;->a:Lmt0/i0;

    .line 2
    sget-object v1, Lmt0/i0;->NONE:Lmt0/i0;
    ...
    .line 4
    iput-object v1, p1, Lmt0/n;->a:Lmt0/i0;
...
.method private final newChunkedSink()Lmt0/f0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lmt0/h0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lmt0/h0;
    .locals 2
...
.method private final newKnownLengthSink()Lmt0/f0;
    .locals 2
...
.method private final newUnknownLengthSource()Lmt0/h0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lmt0/f0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lmt0/f0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lmt0/f0;
...
.method public finishRequest()V
    ...
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lmt0/d;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lmt0/h0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lmt0/h0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lmt0/h0;
    ...
    .line 5
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lmt0/h0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lmt0/h0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lmt0/d;->Q0(Ljava/lang/String;)Lmt0/d;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lmt0/d;->Q0(Ljava/lang/String;)Lmt0/d;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lmt0/d;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v4}, Lmt0/d;->Q0(Ljava/lang/String;)Lmt0/d;
    ...
    .line 7
    invoke-interface {v3, v0}, Lmt0/d;->Q0(Ljava/lang/String;)Lmt0/d;
    ...
    .line 8
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lmt0/d;
