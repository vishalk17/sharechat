...
.field public final launcherRoot:Landroid/view/View;

.field public final listener:Lio/intercom/android/sdk/overlay/DefaultLauncher$Listener;
...
.method public setLauncherLogo(Lio/intercom/android/sdk/identity/AppConfig;)V
    ...
    invoke-direct {v2, v0}, Lw7/i$a;-><init>(Landroid/content/Context;)V
    ...
    .line 6
    sget p1, Lio/intercom/android/sdk/R$drawable;->intercom_launcher_icon:I

    .line 7
    invoke-virtual {v2, p1}, Lw7/i$a;->e(I)Lw7/i$a;

    iget-object p1, p0, Lio/intercom/android/sdk/overlay/DefaultLauncher;->badge:Landroid/widget/ImageButton;

    .line 8
    invoke-virtual {v2, p1}, Lw7/i$a;->m(Landroid/widget/ImageView;)Lw7/i$a;

    .line 9
    invoke-virtual {v2, v1, v1}, Lw7/i$a;->j(II)Lw7/i$a;
