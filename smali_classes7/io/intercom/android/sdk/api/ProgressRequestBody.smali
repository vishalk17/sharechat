...
.method public writeTo(Lmt0/d;)V
    ...
    .line 5
    invoke-static {v0}, Lmt0/u;->h(Ljava/io/InputStream;)Lmt0/h0;
    ...
    :cond_1
    :goto_0
    invoke-interface {p1}, Lmt0/d;->z0()Lmt0/c;
    ...
    check-cast v8, Lmt0/q;

    invoke-virtual {v8, v0, v6, v7}, Lmt0/q;->read(Lmt0/c;J)J
