...
.field public final sendingParts:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lio/intercom/android/sdk/models/Part;",
...
.method public constructor <init>(Lio/intercom/android/sdk/conversation/ConversationContentPresenter$Host;Landroidx/recyclerview/widget/RecyclerView;Lio/intercom/android/sdk/conversation/ConversationPartAdapter;Landroidx/recyclerview/widget/LinearLayoutManager;Lio/intercom/android/sdk/conversation/IntercomLinkPresenter;Ljava/util/List;Lio/intercom/android/sdk/conversation/SoundPlayer;Lio/intercom/android/sdk/blocks/lib/Blocks;Lio/intercom/android/sdk/blocks/ViewHolderGenerator;Lio/intercom/android/sdk/identity/UserIdentity;Lio/intercom/android/sdk/api/Api;Lio/intercom/android/sdk/metrics/ops/OpsMetricTracker;Lio/intercom/android/sdk/blocks/UploadingImageCache;Landroid/content/Context;Ljava/lang/String;Lio/intercom/android/sdk/metrics/MetricTracker;Lzx/b;Lio/intercom/android/sdk/store/Store;Lio/intercom/android/nexus/NexusClient;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/helpcenter/articles/ArticleStatsArguments;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 21
    iput-object v2, v0, Lio/intercom/android/sdk/conversation/ConversationContentPresenter;->bus:Lzx/b;
    ...
    .line 25
    iput-object v2, v0, Lio/intercom/android/sdk/conversation/ConversationContentPresenter;->articleStatsArguments:Lio/intercom/android/sdk/helpcenter/articles/ArticleStatsArguments;
...
.method public static create(Lio/intercom/android/sdk/conversation/ConversationContentPresenter$Host;Landroidx/recyclerview/widget/RecyclerView;Lio/intercom/android/sdk/conversation/ConversationPartAdapter;Lio/intercom/android/sdk/views/IntercomLinkView;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/api/Api;Ljava/util/List;Ljava/lang/String;Lio/intercom/android/sdk/conversation/SoundPlayer;Lio/intercom/android/sdk/blocks/lib/Blocks;Lio/intercom/android/sdk/identity/UserIdentity;Lio/intercom/android/sdk/metrics/ops/OpsMetricTracker;Landroid/app/Activity;Lio/intercom/android/sdk/store/Store;Lio/intercom/android/nexus/NexusClient;Lio/intercom/android/sdk/helpcenter/articles/ArticleStatsArguments;)Lio/intercom/android/sdk/conversation/ConversationContentPresenter;
    ...
    .line 4
    invoke-virtual/range {v28 .. v28}, Lio/intercom/android/sdk/Injector;->getAppIdentity()Lio/intercom/android/sdk/identity/AppIdentity;
    ...
    .line 5
    invoke-virtual/range {v28 .. v28}, Lio/intercom/android/sdk/Injector;->getUserIdentity()Lio/intercom/android/sdk/identity/UserIdentity;
    ...
    .line 8
    invoke-virtual/range {v28 .. v28}, Lio/intercom/android/sdk/Injector;->getGson()Lcom/google/gson/Gson;

    move-result-object v7

    invoke-virtual/range {v28 .. v28}, Lio/intercom/android/sdk/Injector;->getBus()Lzx/b;

    move-result-object v9

    invoke-virtual/range {v28 .. v28}, Lio/intercom/android/sdk/Injector;->getMetricTracker()Lio/intercom/android/sdk/metrics/MetricTracker;
    ...
    invoke-direct/range {v11 .. v32}, Lio/intercom/android/sdk/conversation/ConversationContentPresenter;-><init>(Lio/intercom/android/sdk/conversation/ConversationContentPresenter$Host;Landroidx/recyclerview/widget/RecyclerView;Lio/intercom/android/sdk/conversation/ConversationPartAdapter;Landroidx/recyclerview/widget/LinearLayoutManager;Lio/intercom/android/sdk/conversation/IntercomLinkPresenter;Ljava/util/List;Lio/intercom/android/sdk/conversation/SoundPlayer;Lio/intercom/android/sdk/blocks/lib/Blocks;Lio/intercom/android/sdk/blocks/ViewHolderGenerator;Lio/intercom/android/sdk/identity/UserIdentity;Lio/intercom/android/sdk/api/Api;Lio/intercom/android/sdk/metrics/ops/OpsMetricTracker;Lio/intercom/android/sdk/blocks/UploadingImageCache;Landroid/content/Context;Ljava/lang/String;Lio/intercom/android/sdk/metrics/MetricTracker;Lzx/b;Lio/intercom/android/sdk/store/Store;Lio/intercom/android/nexus/NexusClient;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/helpcenter/articles/ArticleStatsArguments;)V
...
.method public formSubmitSuccess(Lio/intercom/android/sdk/models/events/FormSubmitSuccessEvent;)V
    ...
    iget-object v2, p0, Lio/intercom/android/sdk/conversation/ConversationContentPresenter;->bus:Lzx/b;

    invoke-direct {v1, p1, v2}, Lio/intercom/android/sdk/conversation/attribute/AttributeAnimateEndListener;-><init>(Lio/intercom/android/sdk/models/Conversation;Lzx/b;)V
    ...
    .line 14
    iget-object v0, p0, Lio/intercom/android/sdk/conversation/ConversationContentPresenter;->bus:Lzx/b;

    invoke-virtual {v0, p1}, Lzx/b;->post(Ljava/lang/Object;)V
