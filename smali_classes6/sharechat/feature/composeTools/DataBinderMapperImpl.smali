...
.method public final b(Landroidx/databinding/f;Landroid/view/View;I)Landroidx/databinding/ViewDataBinding;
    ...
    .line 4
    new-instance p3, Lw71/l1;

    invoke-direct {p3, p1, p2}, Lw71/l1;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_text_template_category is invalid. Received: "
    ...
    .line 9
    new-instance p3, Lw71/j1;

    invoke-direct {p3, p1, p2}, Lw71/j1;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_text_template is invalid. Received: "
    ...
    .line 14
    new-instance p3, Lw71/e1;

    invoke-direct {p3, p1, p2}, Lw71/e1;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_blank_layout is invalid. Received: "
    ...
    .line 19
    new-instance p3, Lw71/z0;

    invoke-direct {p3, p1, p2}, Lw71/z0;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for layout_recyclerview_text_template is invalid. Received: "
    ...
    .line 24
    new-instance p3, Lw71/p;

    invoke-direct {p3, p1, p2}, Lw71/p;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for fragment_gallery_media is invalid. Received: "
...
.method public final c(Landroidx/databinding/f;[Landroid/view/View;I)Landroidx/databinding/ViewDataBinding;
    ...
    .line 2
    :cond_0
    sget-object p1, Lsharechat/feature/composeTools/DataBinderMapperImpl;->a:Landroid/util/SparseIntArray;
