...
.method public final b(Landroidx/databinding/f;Landroid/view/View;I)Landroidx/databinding/ViewDataBinding;
    ...
    .line 4
    new-instance p3, Lya1/n;

    invoke-direct {p3, p1, p2}, Lya1/n;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_tab_text is invalid. Received: "
    ...
    .line 9
    new-instance p3, Lya1/l;

    invoke-direct {p3, p1, p2}, Lya1/l;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_cluster_tab_horizontal is invalid. Received: "
    ...
    .line 14
    new-instance p3, Lya1/j;

    invoke-direct {p3, p1, p2}, Lya1/j;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_cluster_tab is invalid. Received: "
    ...
    .line 19
    new-instance p3, Lya1/h;

    invoke-direct {p3, p1, p2}, Lya1/h;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_cluster_horizontal_additem is invalid. Received: "
    ...
    .line 24
    new-instance p3, Lya1/f;

    invoke-direct {p3, p1, p2}, Lya1/f;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for viewholder_cluster_additem is invalid. Received: "
    ...
    .line 29
    new-instance p3, Lya1/d;

    invoke-direct {p3, p1, p2}, Lya1/d;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for fragment_subgenre_feed is invalid. Received: "
    ...
    .line 34
    new-instance p3, Lya1/b;

    invoke-direct {p3, p1, p2}, Lya1/b;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p2, "The tag for fragment_feed_container is invalid. Received: "
...
.method public final c(Landroidx/databinding/f;[Landroid/view/View;I)Landroidx/databinding/ViewDataBinding;
    ...
    .line 2
    :cond_0
    sget-object p1, Lsharechat/feature/cvfeed/DataBinderMapperImpl;->a:Landroid/util/SparseIntArray;
