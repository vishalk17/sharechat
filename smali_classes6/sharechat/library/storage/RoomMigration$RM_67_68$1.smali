.class public final Lsharechat/library/storage/RoomMigration$RM_67_68$1;
.super Lh6/b;
.source "SourceFile"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "sharechat/library/storage/RoomMigration$RM_67_68$1",
        "Lh6/b;",
        "Ll6/b;",
        "database",
        "Lro0/x;",
...
.method public migrate(Ll6/b;)V
    ...
    const-string v0, "ALTER TABLE `posts` ADD `postCategory` TEXT"

    .line 1
    invoke-interface {p1, v0}, Ll6/b;->A0(Ljava/lang/String;)V

    const-string v0, "ALTER TABLE `posts` ADD `genreCategory` TEXT"
    ...
    const-string v0, "ALTER TABLE `tags` ADD `webCardObject` TEXT"

    .line 4
    invoke-interface {p1, v0}, Ll6/b;->A0(Ljava/lang/String;)V

    const-string v0, "ALTER TABLE `buckets` ADD `isCvBucket` INTEGER NOT NULL DEFAULT 0"
