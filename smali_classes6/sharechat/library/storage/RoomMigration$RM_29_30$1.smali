...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "sharechat/library/storage/RoomMigration$RM_29_30$1",
        "Lh6/b;",
        "Ll6/b;",
        "database",
        "Lro0/x;",
...
.method public migrate(Ll6/b;)V
    ...
    const-string v1, "CREATE TABLE IF NOT EXISTS `camera_drafts` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `cameraDraft` TEXT NOT NULL, `name` TEXT NOT NULL, `thumb` TEXT, `totalTime` INTEGER NOT NULL)"

    const-string v2, "ALTER TABLE `posts` ADD `elanicPostData` TEXT"
