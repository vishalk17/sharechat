...
.method public static onReceiveRegisterResult(Landroid/content/Context;Lcom/xiaomi/push/ij;)V
    .locals 8
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/ij;->a()J
    ...
    iget-object v3, p1, Lcom/xiaomi/push/ij;->f:Ljava/lang/String;
    ...
    sget-object p0, Lcom/xiaomi/push/fc;->a:Lcom/xiaomi/push/fc;

    iget-object v2, p0, Lcom/xiaomi/push/fc;->a:Ljava/lang/String;

    iget-wide v4, p1, Lcom/xiaomi/push/ij;->a:J

    iget-object v6, p1, Lcom/xiaomi/push/ij;->d:Ljava/lang/String;
...
.method public static onReceiveUnregisterResult(Landroid/content/Context;Lcom/xiaomi/push/ip;)V
    .locals 6

    sget-object p0, Lcom/xiaomi/push/fc;->b:Lcom/xiaomi/push/fc;

    iget-object v0, p0, Lcom/xiaomi/push/fc;->a:Ljava/lang/String;

    iget-wide v2, p1, Lcom/xiaomi/push/ip;->a:J

    iget-object v4, p1, Lcom/xiaomi/push/ip;->d:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/ip;->a()Ljava/lang/String;
...
.method public static registerPush(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p3, Lcom/xiaomi/push/fc;->a:Lcom/xiaomi/push/fc;

    iget-object v1, p3, Lcom/xiaomi/push/fc;->a:Ljava/lang/String;
    ...
    sget-object p3, Lcom/xiaomi/push/hs;->j:Lcom/xiaomi/push/hs;

    iget-object p3, p3, Lcom/xiaomi/push/hs;->a:Ljava/lang/String;

    invoke-virtual {v1, p3}, Lcom/xiaomi/push/ih;->c(Ljava/lang/String;)Lcom/xiaomi/push/ih;

    invoke-static {}, Lcom/xiaomi/push/service/aq;->a()Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v1, p3}, Lcom/xiaomi/push/ih;->a(Ljava/lang/String;)Lcom/xiaomi/push/ih;

    const/4 p3, 0x0

    invoke-virtual {v1, p3}, Lcom/xiaomi/push/ih;->a(Z)Lcom/xiaomi/push/ih;
    ...
    invoke-virtual {v1, p3}, Lcom/xiaomi/push/ii;->e(Ljava/lang/String;)Lcom/xiaomi/push/ii;

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->d(Ljava/lang/String;)Lcom/xiaomi/push/ii;

    invoke-virtual {v1, v0}, Lcom/xiaomi/push/ii;->f(Ljava/lang/String;)Lcom/xiaomi/push/ii;
    ...
    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->b(I)Lcom/xiaomi/push/ii;

    const-string p1, "3_7_8"

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->h(Ljava/lang/String;)Lcom/xiaomi/push/ii;

    const/16 p1, 0x77f4

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->a(I)Lcom/xiaomi/push/ii;

    invoke-static {p0}, Lcom/xiaomi/push/i;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->i(Ljava/lang/String;)Lcom/xiaomi/push/ii;

    sget-object p1, Lcom/xiaomi/push/hw;->c:Lcom/xiaomi/push/hw;

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->a(Lcom/xiaomi/push/hw;)Lcom/xiaomi/push/ii;
    ...
    invoke-static {p1}, Lcom/xiaomi/push/bi;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->k(Ljava/lang/String;)Lcom/xiaomi/push/ii;
    ...
    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->j(Ljava/lang/String;)Lcom/xiaomi/push/ii;
    ...
    invoke-virtual {v1, p1}, Lcom/xiaomi/push/ii;->c(I)Lcom/xiaomi/push/ii;
    ...
    sget-object p2, Lcom/xiaomi/push/hs;->J:Lcom/xiaomi/push/hs;

    iget-object p2, p2, Lcom/xiaomi/push/hs;->a:Ljava/lang/String;

    invoke-virtual {p1, p2}, Lcom/xiaomi/push/ih;->c(Ljava/lang/String;)Lcom/xiaomi/push/ih;
    ...
    invoke-virtual {p1, p2}, Lcom/xiaomi/push/ih;->b(Ljava/lang/String;)Lcom/xiaomi/push/ih;

    invoke-virtual {p0}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/xiaomi/push/ih;->d(Ljava/lang/String;)Lcom/xiaomi/push/ih;

    invoke-static {v1}, Lcom/xiaomi/push/is;->a(Lcom/xiaomi/push/it;)[B

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/xiaomi/push/ih;->a([B)Lcom/xiaomi/push/ih;

    invoke-static {}, Lcom/xiaomi/push/service/aq;->a()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/xiaomi/push/ih;->a(Ljava/lang/String;)Lcom/xiaomi/push/ih;

    invoke-static {p0}, Lcom/xiaomi/mipush/sdk/aq;->a(Landroid/content/Context;)Lcom/xiaomi/mipush/sdk/aq;

    move-result-object p0

    sget-object p2, Lcom/xiaomi/push/hi;->i:Lcom/xiaomi/push/hi;

    const/4 p3, 0x0

    invoke-virtual {p0, p1, p2, p3}, Lcom/xiaomi/mipush/sdk/aq;->a(Lcom/xiaomi/push/it;Lcom/xiaomi/push/hi;Lcom/xiaomi/push/hv;)V
...
.method public static removeDuplicateCache(Landroid/content/Context;Lcom/xiaomi/mipush/sdk/MiPushMessage;)V
    ...
    :cond_1
    invoke-static {p0, v0}, Lcom/xiaomi/mipush/sdk/an;->a(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static reportMessageArrived(Landroid/content/Context;Lcom/xiaomi/mipush/sdk/MiPushMessage;Z)V
    ...
    invoke-virtual {v2, v3}, Lcom/xiaomi/push/hy;->b(Ljava/lang/String;)Lcom/xiaomi/push/hy;

    invoke-virtual {p1}, Lcom/xiaomi/mipush/sdk/MiPushMessage;->getMessageId()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/xiaomi/push/hy;->a(Ljava/lang/String;)Lcom/xiaomi/push/hy;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/xiaomi/push/hy;->a(J)Lcom/xiaomi/push/hy;

    invoke-static {p1, p2}, Lcom/xiaomi/mipush/sdk/MiPushClient4Hybrid;->getDeviceStatus(Lcom/xiaomi/mipush/sdk/MiPushMessage;Z)S

    move-result p2

    invoke-virtual {v2, p2}, Lcom/xiaomi/push/hy;->a(S)Lcom/xiaomi/push/hy;
    ...
    invoke-virtual {v2, p2}, Lcom/xiaomi/push/hy;->c(Ljava/lang/String;)Lcom/xiaomi/push/hy;

    :cond_1
    invoke-static {p1}, Lcom/xiaomi/mipush/sdk/PushMessageHelper;->generateMessage(Lcom/xiaomi/mipush/sdk/MiPushMessage;)Lcom/xiaomi/push/hv;
    ...
    sget-object v3, Lcom/xiaomi/push/hi;->f:Lcom/xiaomi/push/hi;

    const/4 v4, 0x0

    invoke-virtual {p0, v2, v3, v4, p2}, Lcom/xiaomi/mipush/sdk/aq;->a(Lcom/xiaomi/push/it;Lcom/xiaomi/push/hi;ZLcom/xiaomi/push/hv;)V
...
.method public static unregisterPush(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v1}, Lcom/xiaomi/push/io;-><init>()V

    invoke-static {}, Lcom/xiaomi/push/service/aq;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/xiaomi/push/io;->a(Ljava/lang/String;)Lcom/xiaomi/push/io;

    invoke-virtual {v1, p1}, Lcom/xiaomi/push/io;->d(Ljava/lang/String;)Lcom/xiaomi/push/io;

    iget-object v2, v0, Lcom/xiaomi/mipush/sdk/b$a;->a:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/xiaomi/push/io;->b(Ljava/lang/String;)Lcom/xiaomi/push/io;

    iget-object v2, v0, Lcom/xiaomi/mipush/sdk/b$a;->c:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/xiaomi/push/io;->c(Ljava/lang/String;)Lcom/xiaomi/push/io;

    iget-object v0, v0, Lcom/xiaomi/mipush/sdk/b$a;->b:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lcom/xiaomi/push/io;->e(Ljava/lang/String;)Lcom/xiaomi/push/io;

    new-instance v0, Lcom/xiaomi/push/ih;

    invoke-direct {v0}, Lcom/xiaomi/push/ih;-><init>()V

    sget-object v2, Lcom/xiaomi/push/hs;->L:Lcom/xiaomi/push/hs;
...
.method public static uploadClearMessageData(Landroid/content/Context;Ljava/util/LinkedList;)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/push/service/ab;->a(Landroid/content/Context;Ljava/util/LinkedList;)V
