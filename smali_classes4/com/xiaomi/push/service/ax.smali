...
# interfaces
.implements Lcom/xiaomi/push/cq$a;
...
.method public static a(Lcom/xiaomi/push/service/XMPushService;)V
    ...
    const-class v1, Lcom/xiaomi/push/cq;

    monitor-enter v1

    :try_start_0
    invoke-static {v0}, Lcom/xiaomi/push/cq;->a(Lcom/xiaomi/push/cq$a;)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/xiaomi/push/cq;->a(Landroid/content/Context;Lcom/xiaomi/push/cp;Lcom/xiaomi/push/cq$b;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public a(Landroid/content/Context;Lcom/xiaomi/push/cp;Lcom/xiaomi/push/cq$b;Ljava/lang/String;)Lcom/xiaomi/push/cq;
    .locals 1

    new-instance v0, Lcom/xiaomi/push/service/ax$b;

    invoke-direct {v0, p1, p2, p3, p4}, Lcom/xiaomi/push/service/ax$b;-><init>(Landroid/content/Context;Lcom/xiaomi/push/cp;Lcom/xiaomi/push/cq$b;Ljava/lang/String;)V

    return-object v0
.end method

.method public a(Lcom/xiaomi/push/eb$a;)V
    .locals 0
...
.method public a(Lcom/xiaomi/push/ec$b;)V
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/ec$b;->b()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lcom/xiaomi/push/ec$b;->a()Z
    ...
    iget-wide v2, p0, Lcom/xiaomi/push/service/ax;->a:J
    ...
    iput-wide v0, p0, Lcom/xiaomi/push/service/ax;->a:J

    invoke-static {}, Lcom/xiaomi/push/cq;->a()Lcom/xiaomi/push/cq;

    move-result-object p1

    invoke-virtual {p1}, Lcom/xiaomi/push/cq;->a()V

    invoke-virtual {p1}, Lcom/xiaomi/push/cq;->b()V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/fo;->a()Lcom/xiaomi/push/fp;

    move-result-object v1

    invoke-virtual {v1}, Lcom/xiaomi/push/fp;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1, v1}, Lcom/xiaomi/push/cq;->b(Ljava/lang/String;)Lcom/xiaomi/push/cm;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lcom/xiaomi/push/cm;->a()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/fo;->a()Ljava/lang/String;
