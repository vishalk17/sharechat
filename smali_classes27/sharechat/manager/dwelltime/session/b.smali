.class public final Lsharechat/manager/dwelltime/session/b;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lsharechat/manager/dwelltime/session/a;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lsharechat/manager/dwelltime/session/b$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lsharechat/manager/dwelltime/session/b$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lsharechat/manager/dwelltime/session/b$a;-><init>(Lkotlin/jvm/internal/h;)V
...
.method public constructor <init>(Lmj0/a;Lkotlinx/coroutines/s0;Lcs/a;)V
    ...
    .line 2
    iput-object p1, p0, Lsharechat/manager/dwelltime/session/b;->a:Lmj0/a;

    .line 3
    iput-object p2, p0, Lsharechat/manager/dwelltime/session/b;->b:Lkotlinx/coroutines/s0;

    .line 4
    iput-object p3, p0, Lsharechat/manager/dwelltime/session/b;->c:Lcs/a;

    return-void
.end method

.method public static final synthetic c(Lsharechat/manager/dwelltime/session/b;)Ljava/lang/Long;
    .locals 0

    .line 1
    iget-object p0, p0, Lsharechat/manager/dwelltime/session/b;->d:Ljava/lang/Long;

    return-object p0
.end method

.method public static final synthetic d(Lsharechat/manager/dwelltime/session/b;Lkotlin/coroutines/d;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lsharechat/manager/dwelltime/session/b;->g(Lkotlin/coroutines/d;)Ljava/lang/Object;
...
.method public static final synthetic e(Lsharechat/manager/dwelltime/session/b;Ljava/lang/Long;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lsharechat/manager/dwelltime/session/b;->d:Ljava/lang/Long;

    return-void
.end method

.method public static final synthetic f(Lsharechat/manager/dwelltime/session/b;JLkotlin/coroutines/d;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lsharechat/manager/dwelltime/session/b;->h(JLkotlin/coroutines/d;)Ljava/lang/Object;
...
.method private final g(Lkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    instance-of v1, p1, Lsharechat/manager/dwelltime/session/b$c;

    if-eqz v1, :cond_0

    move-object v1, p1

    check-cast v1, Lsharechat/manager/dwelltime/session/b$c;

    iget v2, v1, Lsharechat/manager/dwelltime/session/b$c;->e:I
    ...
    iput v2, v1, Lsharechat/manager/dwelltime/session/b$c;->e:I

    goto :goto_0

    :cond_0
    new-instance v1, Lsharechat/manager/dwelltime/session/b$c;

    invoke-direct {v1, p0, p1}, Lsharechat/manager/dwelltime/session/b$c;-><init>(Lsharechat/manager/dwelltime/session/b;Lkotlin/coroutines/d;)V

    :goto_0
    iget-object p1, v1, Lsharechat/manager/dwelltime/session/b$c;->c:Ljava/lang/Object;
    ...
    .line 1
    iget v3, v1, Lsharechat/manager/dwelltime/session/b$c;->e:I
    ...
    iget-object v0, v1, Lsharechat/manager/dwelltime/session/b$c;->b:Ljava/lang/Object;
    ...
    .line 4
    iget-object p1, p0, Lsharechat/manager/dwelltime/session/b;->a:Lmj0/a;

    const-string v3, "common_sharechat_prefv2"

    const-string v7, "SESSION_ID_TIMEOUT_KEY"
    ...
    .line 17
    iput-object v8, v1, Lsharechat/manager/dwelltime/session/b$c;->b:Ljava/lang/Object;

    iput v6, v1, Lsharechat/manager/dwelltime/session/b$c;->e:I
...
.method private final h(JLkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lsharechat/manager/dwelltime/session/b;->a:Lmj0/a;
...
.method public a(Lkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lsharechat/manager/dwelltime/session/b;->c:Lcs/a;

    invoke-interface {v0}, Lin/mohalla/androidcommon/async/coroutine/a;->d()Lkotlinx/coroutines/l0;

    move-result-object v0

    new-instance v1, Lsharechat/manager/dwelltime/session/b$b;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lsharechat/manager/dwelltime/session/b$b;-><init>(Lsharechat/manager/dwelltime/session/b;Lkotlin/coroutines/d;)V
...
.method public b(J)V
    ...
    iput-object v0, p0, Lsharechat/manager/dwelltime/session/b;->d:Ljava/lang/Long;

    .line 2
    iget-object v1, p0, Lsharechat/manager/dwelltime/session/b;->b:Lkotlinx/coroutines/s0;
    ...
    new-instance v4, Lsharechat/manager/dwelltime/session/b$d;

    const/4 v0, 0x0

    invoke-direct {v4, p0, p1, p2, v0}, Lsharechat/manager/dwelltime/session/b$d;-><init>(Lsharechat/manager/dwelltime/session/b;JLkotlin/coroutines/d;)V
