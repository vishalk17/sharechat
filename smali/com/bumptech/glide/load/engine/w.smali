...
.field private k:Lcom/bumptech/glide/load/engine/x;
...
.method constructor <init>(Lcom/bumptech/glide/load/engine/g;Lcom/bumptech/glide/load/engine/f$a;)V
    ...
    .line 2
    iput v0, p0, Lcom/bumptech/glide/load/engine/w;->e:I

    .line 3
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;

    .line 4
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/w;->b:Lcom/bumptech/glide/load/engine/f$a;
...
.method private b()Z
    ...
    .line 1
    iget v0, p0, Lcom/bumptech/glide/load/engine/w;->h:I

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->g:Ljava/util/List;
...
.method public a()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;
    ...
    .line 3
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/w;->g:Ljava/util/List;
    ...
    .line 10
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/w;->i:Lcom/bumptech/glide/load/model/n$a;
    ...
    .line 12
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/w;->g:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/w;->h:I

    add-int/lit8 v3, v1, 0x1

    iput v3, p0, Lcom/bumptech/glide/load/engine/w;->h:I
    ...
    .line 13
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->j:Ljava/io/File;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/engine/g;->f()I

    move-result v5

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;
    ...
    .line 16
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/w;->i:Lcom/bumptech/glide/load/model/n$a;

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->i:Lcom/bumptech/glide/load/model/n$a;
    ...
    invoke-interface {v0, v1, p0}, Lcom/bumptech/glide/load/data/d;->d(Lcom/bumptech/glide/e;Lcom/bumptech/glide/load/data/d$a;)V
    ...
    iput v3, p0, Lcom/bumptech/glide/load/engine/w;->e:I
    ...
    .line 22
    :cond_7
    iput v2, p0, Lcom/bumptech/glide/load/engine/w;->e:I
    ...
    .line 24
    iget v4, p0, Lcom/bumptech/glide/load/engine/w;->e:I
    ...
    .line 25
    iget-object v4, p0, Lcom/bumptech/glide/load/engine/w;->c:Lcom/bumptech/glide/load/engine/g;
    ...
    iput-object v13, p0, Lcom/bumptech/glide/load/engine/w;->k:Lcom/bumptech/glide/load/engine/x;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/w;->k:Lcom/bumptech/glide/load/engine/x;

    invoke-interface {v4, v5}, Lcom/bumptech/glide/load/engine/cache/a;->b(Lcom/bumptech/glide/load/g;)Ljava/io/File;

    move-result-object v4

    iput-object v4, p0, Lcom/bumptech/glide/load/engine/w;->j:Ljava/io/File;

    if-eqz v4, :cond_2

    .line 33
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/w;->f:Lcom/bumptech/glide/load/g;
    ...
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/w;->g:Ljava/util/List;

    .line 35
    iput v2, p0, Lcom/bumptech/glide/load/engine/w;->h:I
...
.method public e(Ljava/lang/Object;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/w;->b:Lcom/bumptech/glide/load/engine/f$a;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->f:Lcom/bumptech/glide/load/g;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/w;->i:Lcom/bumptech/glide/load/model/n$a;
...
.method public f(Ljava/lang/Exception;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/w;->k:Lcom/bumptech/glide/load/engine/x;
    ...
    invoke-interface {v0, v1, p1, v2, v3}, Lcom/bumptech/glide/load/engine/f$a;->c(Lcom/bumptech/glide/load/g;Ljava/lang/Exception;Lcom/bumptech/glide/load/data/d;Lcom/bumptech/glide/load/a;)V
