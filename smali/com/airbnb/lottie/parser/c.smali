...
.method private static a(Lcom/airbnb/lottie/model/animatable/e;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lcom/airbnb/lottie/model/animatable/e;->i()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Lcom/airbnb/lottie/model/animatable/e;->k()Ljava/util/List;
...
.method private static b(Lcom/airbnb/lottie/model/animatable/m;)Z
    ...
    .line 2
    invoke-interface {p0}, Lcom/airbnb/lottie/model/animatable/m;->i()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-interface {p0}, Lcom/airbnb/lottie/model/animatable/m;->k()Ljava/util/List;
...
.method private static c(Lcom/airbnb/lottie/model/animatable/b;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lcom/airbnb/lottie/model/animatable/b;->i()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Lcom/airbnb/lottie/model/animatable/b;->k()Ljava/util/List;
...
.method private static d(Lcom/airbnb/lottie/model/animatable/g;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lcom/airbnb/lottie/model/animatable/g;->i()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Lcom/airbnb/lottie/model/animatable/g;->k()Ljava/util/List;
    ...
    invoke-virtual {p0, v1, v1}, Lv3/d;->a(FF)Z
...
.method public static g(Lcom/airbnb/lottie/parser/moshi/c;Lcom/airbnb/lottie/d;)Lcom/airbnb/lottie/model/animatable/l;
    .locals 27
    ...
    .line 1
    invoke-virtual/range {p0 .. p0}, Lcom/airbnb/lottie/parser/moshi/c;->s()Lcom/airbnb/lottie/parser/moshi/c$b;
    ...
    .line 7
    :pswitch_0
    invoke-static {v0, v8, v9}, Lcom/airbnb/lottie/parser/d;->f(Lcom/airbnb/lottie/parser/moshi/c;Lcom/airbnb/lottie/d;Z)Lcom/airbnb/lottie/model/animatable/b;
    ...
    .line 14
    invoke-virtual/range {v17 .. v17}, Lcom/airbnb/lottie/model/animatable/b;->k()Ljava/util/List;
    ...
    invoke-direct/range {v1 .. v7}, Lv3/a;-><init>(Lcom/airbnb/lottie/d;Ljava/lang/Object;Ljava/lang/Object;Landroid/view/animation/Interpolator;FLjava/lang/Float;)V
    ...
    .line 18
    invoke-static/range {p0 .. p1}, Lcom/airbnb/lottie/parser/d;->j(Lcom/airbnb/lottie/parser/moshi/c;Lcom/airbnb/lottie/d;)Lcom/airbnb/lottie/model/animatable/g;
    ...
    .line 19
    invoke-static/range {p0 .. p1}, Lcom/airbnb/lottie/parser/a;->b(Lcom/airbnb/lottie/parser/moshi/c;Lcom/airbnb/lottie/d;)Lcom/airbnb/lottie/model/animatable/m;
    ...
    .line 25
    :cond_4
    invoke-static/range {p0 .. p1}, Lcom/airbnb/lottie/parser/a;->a(Lcom/airbnb/lottie/parser/moshi/c;Lcom/airbnb/lottie/d;)Lcom/airbnb/lottie/model/animatable/e;
