...
# static fields
.field private static v:Ljava/lang/String; = "ViewTransition"
...
.method constructor <init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 21
    sget-object v3, Landroidx/constraintlayout/motion/widget/t;->v:Ljava/lang/String;
    ...
    .line 22
    sget-object v2, Landroidx/constraintlayout/motion/widget/t;->v:Ljava/lang/String;
    ...
    .line 23
    :cond_3
    iget-object v2, p0, Landroidx/constraintlayout/motion/widget/t;->g:Landroidx/constraintlayout/widget/d$a;
    ...
    iput-object v2, p0, Landroidx/constraintlayout/motion/widget/t;->g:Landroidx/constraintlayout/widget/d$a;
    ...
    .line 26
    :cond_6
    invoke-direct {p0, p1, p2}, Landroidx/constraintlayout/motion/widget/t;->l(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method public static synthetic a(Landroidx/constraintlayout/motion/widget/t;[Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Landroidx/constraintlayout/motion/widget/t;->j([Landroid/view/View;)V
...
.method private l(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 8
    sget-boolean v2, Landroidx/constraintlayout/motion/widget/MotionLayout;->x1:Z
...
.method private n(Landroidx/constraintlayout/motion/widget/q$b;Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/constraintlayout/motion/widget/q$b;->G(I)V
    ...
    invoke-virtual {p1, v0, v2, v3}, Landroidx/constraintlayout/motion/widget/q$b;->F(ILjava/lang/String;I)V
    ...
    invoke-virtual {v2, p2}, Landroidx/constraintlayout/motion/widget/d;->h(I)Landroidx/constraintlayout/motion/widget/d;
    ...
    .line 11
    :cond_1
    invoke-virtual {p1, v1}, Landroidx/constraintlayout/motion/widget/q$b;->t(Landroidx/constraintlayout/motion/widget/g;)V
...
# virtual methods
.method b(Landroidx/constraintlayout/motion/widget/u;Landroidx/constraintlayout/motion/widget/MotionLayout;Landroid/view/View;)V
    .locals 9
    ...
    .line 2
    invoke-virtual {v6, p3}, Landroidx/constraintlayout/motion/widget/m;->y(Landroid/view/View;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/motion/widget/m;->F(IIFJ)V
...
.method varargs c(Landroidx/constraintlayout/motion/widget/u;Landroidx/constraintlayout/motion/widget/MotionLayout;ILandroidx/constraintlayout/widget/d;[Landroid/view/View;)V
    .locals 7
    ...
    .line 7
    :cond_2
    invoke-virtual {p2, v1}, Landroidx/constraintlayout/motion/widget/MotionLayout;->s0(I)Landroidx/constraintlayout/widget/d;
    ...
    invoke-virtual {v1, v5}, Landroidx/constraintlayout/widget/d;->z(I)Landroidx/constraintlayout/widget/d$a;

    move-result-object v5

    .line 10
    iget-object v6, p0, Landroidx/constraintlayout/motion/widget/t;->g:Landroidx/constraintlayout/widget/d$a;
    ...
    .line 14
    invoke-virtual {p1, p4}, Landroidx/constraintlayout/widget/d;->q(Landroidx/constraintlayout/widget/d;)V
    ...
    invoke-virtual {p1, v3}, Landroidx/constraintlayout/widget/d;->z(I)Landroidx/constraintlayout/widget/d$a;

    move-result-object v3

    .line 17
    iget-object v4, p0, Landroidx/constraintlayout/motion/widget/t;->g:Landroidx/constraintlayout/widget/d$a;
    ...
    .line 20
    :cond_7
    invoke-virtual {p2, p3, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout;->Q0(ILandroidx/constraintlayout/widget/d;)V

    .line 21
    sget p1, Landroidx/constraintlayout/widget/R$id;->view_transition:I

    invoke-virtual {p2, p1, p4}, Landroidx/constraintlayout/motion/widget/MotionLayout;->Q0(ILandroidx/constraintlayout/widget/d;)V

    const/4 p4, -0x1

    .line 22
    invoke-virtual {p2, p1, p4, p4}, Landroidx/constraintlayout/motion/widget/MotionLayout;->E0(III)V

    .line 23
    new-instance v0, Landroidx/constraintlayout/motion/widget/q$b;

    iget-object v1, p2, Landroidx/constraintlayout/motion/widget/MotionLayout;->v:Landroidx/constraintlayout/motion/widget/q;
    ...
    .line 25
    invoke-direct {p0, v0, p3}, Landroidx/constraintlayout/motion/widget/t;->n(Landroidx/constraintlayout/motion/widget/q$b;Landroid/view/View;)V
...
.method f(Landroid/content/Context;)Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v0, p0, p1}, Landroidx/constraintlayout/motion/widget/t$a;-><init>(Landroidx/constraintlayout/motion/widget/t;Landroidx/constraintlayout/core/motion/utils/d;)V
