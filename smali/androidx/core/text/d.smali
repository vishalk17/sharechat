...
.method private constructor <init>(Landroid/text/PrecomputedText;Landroidx/core/text/d$a;)V
    .locals 1
    ...
    .line 6
    iput-object p1, p0, Landroidx/core/text/d;->b:Landroid/text/Spannable;

    .line 7
    iput-object p2, p0, Landroidx/core/text/d;->c:Landroidx/core/text/d$a;
    ...
    :goto_0
    iput-object p1, p0, Landroidx/core/text/d;->d:Landroid/text/PrecomputedText;

    return-void
.end method

.method private constructor <init>(Ljava/lang/CharSequence;Landroidx/core/text/d$a;[I)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/core/text/d;->b:Landroid/text/Spannable;
...
.method public static a(Ljava/lang/CharSequence;Landroidx/core/text/d$a;)Landroidx/core/text/d;
    .locals 11
    ...
    iget-object v0, p1, Landroidx/core/text/d$a;->e:Landroid/text/PrecomputedText$Params;

    if-eqz v0, :cond_0

    .line 5
    new-instance v1, Landroidx/core/text/d;
    ...
    invoke-direct {v1, p0, p1}, Landroidx/core/text/d;-><init>(Landroid/text/PrecomputedText;Landroidx/core/text/d$a;)V
    :try_end_0
    ...
    :cond_5
    :goto_3
    new-instance v0, Landroidx/core/text/d;

    invoke-direct {v0, p0, p1, v1}, Landroidx/core/text/d;-><init>(Ljava/lang/CharSequence;Landroidx/core/text/d$a;[I)V
    :try_end_1
...
# virtual methods
.method public b()Landroidx/core/text/d$a;
    .locals 1
...
.method public c()Landroid/text/PrecomputedText;
    ...
    .line 1
    iget-object v0, p0, Landroidx/core/text/d;->b:Landroid/text/Spannable;
