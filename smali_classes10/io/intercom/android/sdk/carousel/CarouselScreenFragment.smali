...
.method private applyBottomGradient(Landroid/view/View;Lio/intercom/android/sdk/views/ContentAwareScrollView;I)V
    ...
    .line 1
    invoke-static {p3, v0}, Landroidx/core/graphics/d;->q(II)I
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v1, v0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->carouselScreen:Lio/intercom/android/sdk/models/carousel/CarouselScreen;
    ...
    .line 5
    invoke-virtual {v1}, Lio/intercom/android/sdk/Injector;->getBus()Lcom/squareup/otto/b;

    move-result-object v2

    iput-object v2, v0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->bus:Lcom/squareup/otto/b;
    ...
    invoke-direct/range {v2 .. v13}, Lio/intercom/android/sdk/blocks/ViewHolderGenerator;-><init>(Lio/intercom/android/sdk/blocks/UploadingImageCache;Lio/intercom/android/sdk/api/Api;Lio/intercom/android/sdk/Provider;Ljava/lang/String;Lio/intercom/android/sdk/blocks/ImageClickListener;Lio/intercom/android/sdk/blocks/ButtonClickListener;Lcom/bumptech/glide/h;Lcom/google/gson/Gson;Lcom/squareup/otto/b;Lio/intercom/android/sdk/metrics/MetricTracker;Landroid/app/Activity;)V

    .line 9
    new-instance v1, Lio/intercom/android/sdk/blocks/ContentLayoutManager;
    ...
    .line 10
    invoke-virtual {v14}, Lio/intercom/android/sdk/blocks/ViewHolderGenerator;->getCarouselHolder()Lio/intercom/android/sdk/blocks/lib/BlocksViewHolder;

    move-result-object v3

    invoke-direct {v1, v2, v3}, Lio/intercom/android/sdk/blocks/ContentLayoutManager;-><init>(Landroid/content/Context;Lio/intercom/android/sdk/blocks/lib/BlocksViewHolder;)V

    .line 11
    new-instance v2, Lio/intercom/android/sdk/carousel/PermissionManager;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getActivity()Landroidx/fragment/app/FragmentActivity;

    move-result-object v3

    invoke-direct {v2, v3}, Lio/intercom/android/sdk/carousel/PermissionManager;-><init>(Landroid/app/Activity;)V

    iput-object v2, v0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->permissionManager:Lio/intercom/android/sdk/carousel/PermissionManager;

    .line 12
    sget v2, Lio/intercom/android/sdk/R$layout;->intercom_fragment_carousel_screen:I
    ...
    .line 13
    sget v3, Lio/intercom/android/sdk/R$id;->intercom_carousel_fragment_root:I
    ...
    .line 14
    sget v4, Lio/intercom/android/sdk/R$id;->intercom_carousel_action_layout:I
    ...
    iput-object v4, v0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->actionLayout:Landroid/widget/LinearLayout;

    .line 15
    sget v4, Lio/intercom/android/sdk/R$id;->intercom_carousel_content_container:I
    ...
    .line 16
    sget v5, Lio/intercom/android/sdk/R$id;->intercom_carousel_gradient:I
    ...
    .line 17
    sget v6, Lio/intercom/android/sdk/R$id;->intercom_carousel_scroll_view:I
    ...
    .line 18
    iget-object v7, v0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->carouselScreen:Lio/intercom/android/sdk/models/carousel/CarouselScreen;

    invoke-virtual {v7}, Lio/intercom/android/sdk/models/carousel/CarouselScreen;->getBackgroundColor()Ljava/lang/String;
    ...
    .line 19
    invoke-direct {p0, v5, v6, v7}, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->applyBottomGradient(Landroid/view/View;Lio/intercom/android/sdk/views/ContentAwareScrollView;I)V
    ...
    .line 22
    iget-object v3, v0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->carouselScreen:Lio/intercom/android/sdk/models/carousel/CarouselScreen;

    invoke-virtual {v1, v3, v4}, Lio/intercom/android/sdk/blocks/ContentLayoutManager;->renderCarouselScreen(Lio/intercom/android/sdk/models/carousel/CarouselScreen;Landroid/widget/FrameLayout;)V
...
.method public onStart()V
    ...
    .line 2
    iget-object v0, p0, Lio/intercom/android/sdk/carousel/CarouselScreenFragment;->bus:Lcom/squareup/otto/b;
