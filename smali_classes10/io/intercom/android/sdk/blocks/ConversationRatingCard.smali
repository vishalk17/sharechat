...
# direct methods
.method constructor <init>(Lio/intercom/android/sdk/api/Api;Ljava/lang/String;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iput-object p4, p0, Lio/intercom/android/sdk/blocks/ConversationRatingCard;->requestManager:Lcom/bumptech/glide/h;
...
.method private setupRatingsLayout()V
    ...
    iget-object v11, p0, Lio/intercom/android/sdk/blocks/ConversationRatingCard;->requestManager:Lcom/bumptech/glide/h;

    invoke-virtual {v9, v6, v10, v11}, Lio/intercom/android/sdk/imageloader/LongTermImageLoader;->loadImage(Ljava/lang/String;Lio/intercom/android/sdk/imageloader/LongTermImageLoader$OnImageReadyListener;Lcom/bumptech/glide/h;)V
...
.method private showRemarkDialog(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/appcompat/app/c$a;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/c$a;
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/appcompat/app/c$a;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/c$a;
    ...
    invoke-direct {v0, p0, p1}, Lio/intercom/android/sdk/blocks/ConversationRatingCard$7;-><init>(Lio/intercom/android/sdk/blocks/ConversationRatingCard;Landroidx/appcompat/app/c;)V

    invoke-virtual {v5, v0}, Landroid/widget/EditText;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    .line 19
    invoke-virtual {p1, v3}, Landroidx/appcompat/app/c;->e(I)Landroid/widget/Button;
    ...
    .line 21
    invoke-virtual {p1, v4}, Landroidx/appcompat/app/c;->e(I)Landroid/widget/Button;
...
.method private updateViewVisibility()V
    ...
    iget-object v1, p0, Lio/intercom/android/sdk/blocks/ConversationRatingCard;->requestManager:Lcom/bumptech/glide/h;

    .line 16
    invoke-virtual {v2, v0, v3, v1}, Lio/intercom/android/sdk/imageloader/LongTermImageLoader;->loadImage(Ljava/lang/String;Lio/intercom/android/sdk/imageloader/LongTermImageLoader$OnImageReadyListener;Lcom/bumptech/glide/h;)V
