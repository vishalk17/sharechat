...
.method constructor <init>(Ljava/util/List;Landroid/content/ClipboardManager;Lio/intercom/android/sdk/conversation/ConversationPartAdapter$Listener;Lio/intercom/android/sdk/views/PartMetadataFormatter;Lio/intercom/android/sdk/utilities/TimeFormatter;Ljava/util/Map;Lio/intercom/android/sdk/api/Api;Landroid/app/Activity;Ljava/lang/String;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/identity/UserIdentity;Lcom/bumptech/glide/h;Lio/intercom/android/sdk/metrics/MetricTracker;Ljava/util/Locale;)V
    ...
    .line 14
    iput-object p12, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->requestManager:Lcom/bumptech/glide/h;

    .line 15
    iput-object p13, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->metricTracker:Lio/intercom/android/sdk/metrics/MetricTracker;

    .line 16
    iput-object p14, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->locale:Ljava/util/Locale;

    return-void
.end method

.method public static create(Landroid/app/Activity;Ljava/util/List;Lio/intercom/android/sdk/conversation/ConversationPartAdapter$Listener;Lio/intercom/android/sdk/api/Api;Ljava/lang/String;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/identity/UserIdentity;Lcom/intercom/commons/utilities/TimeProvider;Lio/intercom/android/sdk/utilities/ContextLocaliser;Lcom/bumptech/glide/h;Lio/intercom/android/sdk/metrics/MetricTracker;Ljava/util/Locale;)Lio/intercom/android/sdk/conversation/ConversationPartAdapter;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {v0, v8}, Lio/intercom/android/sdk/utilities/ContextLocaliser;->createLocalisedContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 5
    new-instance v15, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;
    ...
    invoke-direct/range {v0 .. v14}, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;-><init>(Ljava/util/List;Landroid/content/ClipboardManager;Lio/intercom/android/sdk/conversation/ConversationPartAdapter$Listener;Lio/intercom/android/sdk/views/PartMetadataFormatter;Lio/intercom/android/sdk/utilities/TimeFormatter;Ljava/util/Map;Lio/intercom/android/sdk/api/Api;Landroid/app/Activity;Ljava/lang/String;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/identity/UserIdentity;Lcom/bumptech/glide/h;Lio/intercom/android/sdk/metrics/MetricTracker;Ljava/util/Locale;)V

    return-object v15
.end method

.method private openArticleActivity(Lio/intercom/android/sdk/blocks/lib/models/Block;Lio/intercom/android/sdk/models/Part;Landroid/view/View;)V
    .locals 2
    ...
    invoke-static {p2, p3, v0}, Landroidx/core/app/b;->b(Landroid/app/Activity;Landroid/view/View;Ljava/lang/String;)Landroidx/core/app/b;
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    .line 2
    :pswitch_0
    new-instance v9, Lio/intercom/android/sdk/views/holder/PartViewHolder;
    ...
    iget-object v7, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->requestManager:Lcom/bumptech/glide/h;

    iget-object v8, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->metricTracker:Lio/intercom/android/sdk/metrics/MetricTracker;
    ...
    .line 4
    :pswitch_2
    new-instance v9, Lio/intercom/android/sdk/views/holder/ComposerSuggestionsViewHolder;
    ...
    invoke-direct/range {v0 .. v8}, Lio/intercom/android/sdk/views/holder/ComposerSuggestionsViewHolder;-><init>(Landroid/view/View;ILio/intercom/android/sdk/views/holder/ConversationListener;Landroid/content/ClipboardManager;Lio/intercom/android/sdk/views/PartMetadataFormatter;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;Lio/intercom/android/sdk/metrics/MetricTracker;)V
    ...
    .line 6
    new-instance v6, Lio/intercom/android/sdk/views/holder/AttributeCollectorViewHolder;
    ...
    iget-object v4, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->requestManager:Lcom/bumptech/glide/h;

    iget-object v5, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->locale:Ljava/util/Locale;

    move-object v0, v6

    move-object v3, p0

    invoke-direct/range {v0 .. v5}, Lio/intercom/android/sdk/views/holder/AttributeCollectorViewHolder;-><init>(Landroid/view/View;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/views/holder/ConversationListener;Lcom/bumptech/glide/h;Ljava/util/Locale;)V

    return-object v6

    .line 7
    :pswitch_4
    new-instance v9, Lio/intercom/android/sdk/views/holder/QuickReplyViewHolder;
    ...
    invoke-direct/range {v0 .. v8}, Lio/intercom/android/sdk/views/holder/QuickReplyViewHolder;-><init>(Landroid/view/View;ILio/intercom/android/sdk/views/holder/ConversationListener;Landroid/content/ClipboardManager;Lio/intercom/android/sdk/views/PartMetadataFormatter;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;Lio/intercom/android/sdk/metrics/MetricTracker;)V
    ...
    iget-object v2, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->requestManager:Lcom/bumptech/glide/h;

    invoke-direct {v3, v0, p0, v1, v2}, Lio/intercom/android/sdk/views/holder/LinkListViewHolder;-><init>(Landroid/view/View;Lio/intercom/android/sdk/views/holder/ConversationListener;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)V
    ...
    invoke-direct {v3, v0, v1, v2}, Lio/intercom/android/sdk/views/holder/EventViewHolder;-><init>(Landroid/view/View;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)V
    ...
    invoke-direct {v3, v0, p0, v1, v2}, Lio/intercom/android/sdk/views/holder/ConversationRatingViewHolder;-><init>(Landroid/view/View;Lio/intercom/android/sdk/views/holder/ConversationListener;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)V
    ...
    iget-object v6, p0, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->requestManager:Lcom/bumptech/glide/h;
    ...
    invoke-direct/range {v0 .. v6}, Lio/intercom/android/sdk/views/holder/LinkViewHolder;-><init>(Landroid/view/View;ILio/intercom/android/sdk/views/holder/ConversationListener;Landroid/content/ClipboardManager;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)V
    ...
    invoke-direct/range {v0 .. v7}, Lio/intercom/android/sdk/views/holder/ContainerCardViewHolder;-><init>(Landroid/view/View;ILio/intercom/android/sdk/views/holder/ConversationListener;Landroid/content/ClipboardManager;ZLio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)V
...
.method public onDateAttributeClicked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lio/intercom/android/sdk/conversation/attribute/AttributeInputListener;)V
    ...
    .line 8
    invoke-virtual {v14, v1}, Landroid/app/DatePickerDialog;->getButton(I)Landroid/widget/Button;
...
.method public onLinkClicked(ILandroid/view/View;)V
    ...
    .line 3
    invoke-virtual {v0}, Lio/intercom/android/sdk/blocks/lib/models/Block;->getLinkType()Ljava/lang/String;
    ...
    .line 4
    invoke-direct {p0, v0, p1, p2}, Lio/intercom/android/sdk/conversation/ConversationPartAdapter;->openArticleActivity(Lio/intercom/android/sdk/blocks/lib/models/Block;Lio/intercom/android/sdk/models/Part;Landroid/view/View;)V

    goto :goto_0

    .line 5
    :cond_0
    invoke-virtual {v0}, Lio/intercom/android/sdk/blocks/lib/models/Block;->getUrl()Ljava/lang/String;
...
.method public onListAttributeClicked(Ljava/lang/String;Lio/intercom/android/sdk/models/Attribute;Lio/intercom/android/sdk/conversation/attribute/AttributeInputListener;)V
    ...
    .line 2
    invoke-virtual {v6}, Landroidx/appcompat/app/c$a;->show()Landroidx/appcompat/app/c;
