...
.field private composerButton:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
...
.method private displayErrorView()V
    ...
    .line 8
    iget-object v0, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->composerButton:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
...
.method private setColorScheme()V
    ...
    .line 4
    iget-object v3, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->composerButton:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;

    invoke-static {v1}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-virtual {v3, v1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->setBackgroundTintList(Landroid/content/res/ColorStateList;)V

    .line 5
    iget-object v1, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->composerButton:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
...
.method private setUpToolbar()V
    ...
    iget-object v3, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->requestManager:Lcom/bumptech/glide/h;

    invoke-static {v0, v2, v3}, Lio/intercom/android/sdk/imageloader/WallpaperLoader;->create(Landroid/content/Context;Lio/intercom/android/sdk/Provider;Lcom/bumptech/glide/h;)Lio/intercom/android/sdk/imageloader/WallpaperLoader;
    ...
    .line 15
    iget-object v2, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->intercomToolbar:Lio/intercom/android/sdk/views/IntercomToolbar;

    invoke-virtual {v2, v0}, Lio/intercom/android/sdk/views/IntercomToolbar;->loadWallpaper(Lio/intercom/android/sdk/imageloader/WallpaperLoader;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->requestManager:Lcom/bumptech/glide/h;
    ...
    iget-object v8, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->requestManager:Lcom/bumptech/glide/h;

    move-object v1, v9

    move-object v3, p0

    invoke-direct/range {v1 .. v8}, Lio/intercom/android/sdk/inbox/InboxAdapter;-><init>(Landroid/view/LayoutInflater;Lio/intercom/android/sdk/inbox/ConversationClickListener;Lio/intercom/android/sdk/store/Store;Lio/intercom/android/sdk/utilities/TimeFormatter;Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/identity/UserIdentity;Lcom/bumptech/glide/h;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object p1, p0, Lio/intercom/android/sdk/inbox/InboxFragment;->composerButton:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
...
.method public onStateChange(Lio/intercom/android/sdk/state/InboxState;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/recyclerview/widget/LinearLayoutManager;->H1(I)V
