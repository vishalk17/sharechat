...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lio/intercom/android/sdk/state/UiState$Screen;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lio/intercom/android/sdk/state/UiState$Screen;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lio/intercom/android/sdk/state/UiState$Screen;->HOME:Lio/intercom/android/sdk/state/UiState$Screen;

    .line 4
    new-instance v5, Lio/intercom/android/sdk/state/UiState$Screen;

    const-string v7, "COMPOSER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lio/intercom/android/sdk/state/UiState$Screen;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lio/intercom/android/sdk/state/UiState$Screen;->COMPOSER:Lio/intercom/android/sdk/state/UiState$Screen;

    .line 5
    new-instance v7, Lio/intercom/android/sdk/state/UiState$Screen;

    const-string v9, "CONVERSATION"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lio/intercom/android/sdk/state/UiState$Screen;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lio/intercom/android/sdk/state/UiState$Screen;->CONVERSATION:Lio/intercom/android/sdk/state/UiState$Screen;

    const/4 v9, 0x5

    new-array v9, v9, [Lio/intercom/android/sdk/state/UiState$Screen;
    ...
    .line 6
    sput-object v9, Lio/intercom/android/sdk/state/UiState$Screen;->$VALUES:[Lio/intercom/android/sdk/state/UiState$Screen;
