...
.field private final emptyCallback:Lretrofit2/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lretrofit2/d<",
            "Ljava/lang/Void;",
...
.method public constructor <init>(Landroid/content/Context;Lio/intercom/android/sdk/identity/AppIdentity;Lio/intercom/android/sdk/identity/UserIdentity;Lcom/squareup/otto/b;Lokhttp3/OkHttpClient;Lio/intercom/android/sdk/api/MessengerApi;Lio/intercom/android/sdk/api/CallbackHolder;Lio/intercom/android/sdk/api/RateLimiter;Lio/intercom/android/sdk/store/Store;Lio/intercom/android/sdk/Provider;Lcom/google/gson/Gson;Lio/intercom/android/sdk/metrics/ops/OpsMetricTracker;)V
    ...
    iput-object v0, p0, Lio/intercom/android/sdk/api/Api;->emptyCallback:Lretrofit2/d;
    ...
    .line 7
    iput-object p4, p0, Lio/intercom/android/sdk/api/Api;->bus:Lcom/squareup/otto/b;
...
.method static synthetic access$300(Lio/intercom/android/sdk/api/Api;Ljava/util/Map;Ljava/lang/String;)V
    .locals 0
...
.method private retriableUpdateUser(Ljava/util/Map;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lio/intercom/android/sdk/api/MessengerApi;->updateUser(Ljava/util/Map;)Lretrofit2/b;
...
.method public addConversationQuickReply(Ljava/lang/String;Lio/intercom/android/sdk/models/Part;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->addConversationQuickReply(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 9
    invoke-virtual {p3, p4, v0, p5, p1}, Lio/intercom/android/sdk/api/CallbackHolder;->replyCallback(IZLjava/lang/String;Ljava/lang/String;)Lretrofit2/d;

    move-result-object p1

    invoke-interface {p2, p1}, Lretrofit2/b;->S(Lretrofit2/d;)V
...
.method public addConversationRatingRemark(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->addConversationRatingRemark(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 6
    invoke-virtual {p2, v0}, Lio/intercom/android/sdk/api/CallbackHolder;->loggingCallback(Ljava/lang/String;)Lretrofit2/d;
...
.method public fetchCarousel(Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getCarousel(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 4
    invoke-virtual {v1, p1}, Lio/intercom/android/sdk/api/CallbackHolder;->getCarouselCallback(Ljava/lang/String;)Lretrofit2/d;

    move-result-object p1

    invoke-interface {v0, p1}, Lretrofit2/b;->S(Lretrofit2/d;)V

    return-void
.end method

.method public fetchDefaultGifs(Lretrofit2/d;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, v1}, Lio/intercom/android/sdk/api/MessengerApi;->getGifs(Ljava/util/Map;)Lretrofit2/b;
...
.method public fetchGifs(Ljava/lang/String;Lretrofit2/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p1}, Lio/intercom/android/sdk/api/MessengerApi;->getGifs(Ljava/util/Map;)Lretrofit2/b;
...
.method public fetchHomeCards(Lretrofit2/d;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getHomeCards(Ljava/util/Map;)Lretrofit2/b;
...
.method public fetchSheet(Ljava/util/HashMap;Lretrofit2/d;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getSheet(Ljava/util/Map;)Lretrofit2/b;
...
.method public getConversation(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getConversation(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;

    move-result-object p1

    iget-object v0, p0, Lio/intercom/android/sdk/api/Api;->callbacks:Lio/intercom/android/sdk/api/CallbackHolder;

    invoke-virtual {v0, p2}, Lio/intercom/android/sdk/api/CallbackHolder;->conversationCallback(Ljava/lang/String;)Lretrofit2/d;
...
.method public getInbox()V
    ...
    invoke-interface {v1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getConversations(Ljava/util/Map;)Lretrofit2/b;

    move-result-object v0

    iget-object v1, p0, Lio/intercom/android/sdk/api/Api;->callbacks:Lio/intercom/android/sdk/api/CallbackHolder;

    invoke-virtual {v1}, Lio/intercom/android/sdk/api/CallbackHolder;->inboxCallback()Lretrofit2/d;
...
.method public getInboxBefore(J)V
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getConversations(Ljava/util/Map;)Lretrofit2/b;

    move-result-object p1

    iget-object p2, p0, Lio/intercom/android/sdk/api/Api;->callbacks:Lio/intercom/android/sdk/api/CallbackHolder;

    invoke-virtual {p2}, Lio/intercom/android/sdk/api/CallbackHolder;->inboxCallback()Lretrofit2/d;
...
.method public getLink(Ljava/lang/String;Lretrofit2/d;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getLink(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
...
.method public getUnreadConversations()V
    ...
    invoke-interface {v1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->getUnreadConversations(Ljava/util/Map;)Lretrofit2/b;
...
.method public logEvent(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-interface {p2, p1}, Lio/intercom/android/sdk/api/MessengerApi;->logEvent(Ljava/util/Map;)Lretrofit2/b;
...
.method public markCarouselActionButtonTapped(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-interface {p2, p1}, Lio/intercom/android/sdk/api/MessengerApi;->markCarouselActionButtonTapped(Ljava/util/Map;)Lretrofit2/b;

    move-result-object p1

    iget-object p2, p0, Lio/intercom/android/sdk/api/Api;->emptyCallback:Lretrofit2/d;
...
.method public markCarouselAsCompleted(Ljava/lang/String;Z)V
    ...
    invoke-interface {p2, p1}, Lio/intercom/android/sdk/api/MessengerApi;->markCarouselAsCompleted(Ljava/util/Map;)Lretrofit2/b;
...
.method public markCarouselAsDismissed(Ljava/lang/String;Z)V
    ...
    invoke-interface {p2, p1}, Lio/intercom/android/sdk/api/MessengerApi;->markCarouselAsDismissed(Ljava/util/Map;)Lretrofit2/b;
...
.method public markCarouselScreenViewed(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-interface {p2, p1}, Lio/intercom/android/sdk/api/MessengerApi;->markCarouselScreenViewed(Ljava/util/Map;)Lretrofit2/b;
...
.method public markConversationAsDismissed(Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->markAsDismissed(Ljava/util/Map;)Lretrofit2/b;

    move-result-object p1

    iget-object v0, p0, Lio/intercom/android/sdk/api/Api;->emptyCallback:Lretrofit2/d;
...
.method public markConversationAsRead(Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->markAsRead(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
...
.method public markPermissionGranted(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-interface {p2, p1}, Lio/intercom/android/sdk/api/MessengerApi;->markPermissionGranted(Ljava/util/Map;)Lretrofit2/b;
...
.method public markPushAsOpened(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lio/intercom/android/sdk/api/MessengerApi;->markPushAsOpened(Ljava/util/Map;)Lretrofit2/b;
...
.method public rateConversation(Ljava/lang/String;I)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->rateConversation(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
...
.method public reactToConversation(Ljava/lang/String;I)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->reactToConversation(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
...
.method public reactToLink(Ljava/lang/String;Ljava/lang/String;IZ)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->reactToLink(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 8
    invoke-virtual {p2, p3}, Lio/intercom/android/sdk/api/CallbackHolder;->loggingCallback(Ljava/lang/String;)Lretrofit2/d;
...
.method public recordInteractions(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->recordInteractions(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
...
.method public removeDeviceToken(Ljava/lang/String;Lio/intercom/android/sdk/identity/UserIdentity;)V
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->deleteDeviceToken(Ljava/util/Map;)Lretrofit2/b;
...
.method public replyToConversation(Ljava/lang/String;Ljava/util/List;ILjava/lang/String;Z)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->replyToConversation(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 4
    invoke-virtual {v0, p3, p5, p4, p1}, Lio/intercom/android/sdk/api/CallbackHolder;->replyCallback(IZLjava/lang/String;Ljava/lang/String;)Lretrofit2/d;
...
.method public satisfyOperatorCondition(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p2, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->satisfyCondition(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
...
.method public sendErrorReport(Lio/intercom/android/sdk/errorreporting/ErrorReport;)V
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->reportError(Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 6
    invoke-virtual {v0, v1}, Lio/intercom/android/sdk/api/CallbackHolder;->loggingCallback(Ljava/lang/String;)Lretrofit2/d;
...
.method public sendMetrics(Ljava/util/List;Ljava/util/List;Lretrofit2/d;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->sendMetrics(Ljava/util/Map;)Lretrofit2/b;
...
.method public setDeviceToken(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lio/intercom/android/sdk/api/MessengerApi;->setDeviceToken(Ljava/util/Map;)Lretrofit2/b;
...
.method public startNewConversation(Ljava/util/List;ILjava/lang/String;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->startNewConversation(Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 5
    invoke-virtual {p4, p2, p3}, Lio/intercom/android/sdk/api/CallbackHolder;->newConversationCallback(ILjava/lang/String;)Lretrofit2/d;
...
.method public submitForm(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-interface {p4, p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->submitForm(Ljava/lang/String;Ljava/util/Map;)Lretrofit2/b;
    ...
    .line 10
    invoke-virtual {p4, p2, p3}, Lio/intercom/android/sdk/api/CallbackHolder;->submitFormCallback(Ljava/lang/String;Ljava/lang/String;)Lretrofit2/d;
...
.method public submitSheet(Ljava/lang/String;Ljava/util/Map;Lretrofit2/d;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->submitSheet(Ljava/util/Map;)Lretrofit2/b;
...
.method public triggerInboundCustomBot(Lio/intercom/android/sdk/models/Part;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {p2, v0}, Lio/intercom/android/sdk/api/MessengerApi;->triggerInboundConversation(Ljava/util/Map;)Lretrofit2/b;
    ...
    invoke-virtual {p4, p3, p1}, Lio/intercom/android/sdk/api/CallbackHolder;->triggeredInboundBotCallback(ILjava/lang/String;)Lretrofit2/d;
...
.method public uploadFile(Lcom/intercom/input/gallery/GalleryImage;ILjava/lang/String;Lio/intercom/android/sdk/blocks/UploadingImageCache;Lio/intercom/android/sdk/conversation/UploadProgressListener;Landroid/content/Context;)V
    ...
    invoke-interface {v1, v0}, Lio/intercom/android/sdk/api/MessengerApi;->uploadFile(Ljava/util/Map;)Lretrofit2/b;

    move-result-object v11

    new-instance v12, Lio/intercom/android/sdk/api/Api$2;
    ...
    invoke-direct/range {v0 .. v9}, Lio/intercom/android/sdk/api/Api$2;-><init>(Lio/intercom/android/sdk/api/Api;Lio/intercom/android/sdk/blocks/UploadingImageCache;Lcom/intercom/input/gallery/GalleryImage;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;Lio/intercom/android/sdk/conversation/UploadProgressListener;ILjava/lang/String;)V

    invoke-interface {v11, v12}, Lretrofit2/b;->S(Lretrofit2/d;)V
