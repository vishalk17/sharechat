...
# direct methods
.method constructor <init>(Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;Lio/intercom/android/sdk/store/Store$Reducer;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public reduce(Lio/intercom/android/sdk/actions/Action;Lio/intercom/android/sdk/state/State;)Lio/intercom/android/sdk/state/State;
    ...
    invoke-interface {v0, p1, v8}, Lio/intercom/android/sdk/store/Store$Reducer;->reduce(Lio/intercom/android/sdk/actions/Action;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/intercom/android/sdk/store/StateReducer;->composerSuggestionsReducer:Lio/intercom/android/sdk/store/Store$Reducer;

    .line 11
    invoke-virtual {p2}, Lio/intercom/android/sdk/state/State;->composerSuggestions()Lio/intercom/android/sdk/models/ComposerSuggestions;

    move-result-object v9

    invoke-interface {v0, p1, v9}, Lio/intercom/android/sdk/store/Store$Reducer;->reduce(Lio/intercom/android/sdk/actions/Action;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    move-object v9, v0

    check-cast v9, Lio/intercom/android/sdk/models/ComposerSuggestions;

    iget-object v0, p0, Lio/intercom/android/sdk/store/StateReducer;->messengerStateReducer:Lio/intercom/android/sdk/store/Store$Reducer;

    .line 12
    invoke-virtual {p2}, Lio/intercom/android/sdk/state/State;->messengerState()Lio/intercom/android/sdk/state/MessengerState;

    move-result-object v10

    invoke-interface {v0, p1, v10}, Lio/intercom/android/sdk/store/Store$Reducer;->reduce(Lio/intercom/android/sdk/actions/Action;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    move-object v10, v0

    check-cast v10, Lio/intercom/android/sdk/state/MessengerState;

    iget-object v0, p0, Lio/intercom/android/sdk/store/StateReducer;->programmaticCarouselStateReducer:Lio/intercom/android/sdk/store/Store$Reducer;

    .line 13
    invoke-virtual {p2}, Lio/intercom/android/sdk/state/State;->programmaticCarouselState()Lio/intercom/android/sdk/state/ProgrammaticCarouselState;
    ...
    check-cast v11, Lio/intercom/android/sdk/state/ProgrammaticCarouselState;

    .line 14
    invoke-static/range {v1 .. v11}, Lio/intercom/android/sdk/state/State;->create(ZLio/intercom/android/sdk/state/UiState;Lio/intercom/android/sdk/models/TeamPresence;Ljava/util/Set;Lio/intercom/android/sdk/state/InboxState;Lio/intercom/android/sdk/state/HostAppState;Lio/intercom/android/sdk/state/OverlayState;Lio/intercom/android/sdk/state/ActiveConversationState;Lio/intercom/android/sdk/models/ComposerSuggestions;Lio/intercom/android/sdk/state/MessengerState;Lio/intercom/android/sdk/state/ProgrammaticCarouselState;)Lio/intercom/android/sdk/state/State;
