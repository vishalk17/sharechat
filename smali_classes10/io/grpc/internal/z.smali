...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/z;->k:Lio/grpc/h;
...
.method protected constructor <init>(Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Lio/grpc/u;)V
    ...
    iput-object p1, p0, Lio/grpc/internal/z;->c:Lio/grpc/s;

    .line 6
    invoke-direct {p0, p2, p3}, Lio/grpc/internal/z;->m(Ljava/util/concurrent/ScheduledExecutorService;Lio/grpc/u;)Ljava/util/concurrent/ScheduledFuture;
...
.method static synthetic f(Lio/grpc/internal/z;Lio/grpc/f1;Z)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lio/grpc/internal/z;->j(Lio/grpc/f1;Z)V

    return-void
.end method

.method static synthetic g(Lio/grpc/internal/z;)Lio/grpc/h;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/grpc/internal/z;->f:Lio/grpc/h;

    return-object p0
.end method

.method static synthetic h(Lio/grpc/internal/z;)Lio/grpc/s;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/grpc/internal/z;->c:Lio/grpc/s;

    return-object p0
.end method

.method private j(Lio/grpc/f1;Z)V
    .locals 2
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/z;->f:Lio/grpc/h;

    if-nez v0, :cond_0

    .line 3
    sget-object p2, Lio/grpc/internal/z;->k:Lio/grpc/h;

    .line 4
    invoke-direct {p0, p2}, Lio/grpc/internal/z;->o(Lio/grpc/h;)V

    const/4 p2, 0x0

    .line 5
    iget-object v0, p0, Lio/grpc/internal/z;->e:Lio/grpc/h$a;

    .line 6
    iput-object p1, p0, Lio/grpc/internal/z;->g:Lio/grpc/f1;
    ...
    invoke-direct {p2, p0, p1}, Lio/grpc/internal/z$d;-><init>(Lio/grpc/internal/z;Lio/grpc/f1;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Lio/grpc/internal/z$i;-><init>(Lio/grpc/internal/z;Lio/grpc/h$a;Lio/grpc/f1;)V
...
.method private m(Ljava/util/concurrent/ScheduledExecutorService;Lio/grpc/u;)Ljava/util/concurrent/ScheduledFuture;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object v0, p0, Lio/grpc/internal/z;->c:Lio/grpc/s;

    invoke-virtual {v0}, Lio/grpc/s;->l()Lio/grpc/u;
    ...
    invoke-virtual {p2, v3}, Lio/grpc/u;->k(Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-virtual {v0, v5}, Lio/grpc/u;->k(Ljava/util/concurrent/TimeUnit;)J
    ...
    .line 10
    :cond_2
    invoke-virtual {p2, v5}, Lio/grpc/u;->k(Ljava/util/concurrent/TimeUnit;)J
...
.method private o(Lio/grpc/h;)V
    ...
    invoke-static {v2, v3, v0}, Lcom/google/common/base/p;->x(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    .line 4
    :cond_1
    iput-object p1, p0, Lio/grpc/internal/z;->f:Lio/grpc/h;
...
.method public final e(Lio/grpc/h$a;Lio/grpc/v0;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lio/grpc/internal/z;->e:Lio/grpc/h$a;

    .line 4
    iget-object v0, p0, Lio/grpc/internal/z;->g:Lio/grpc/f1;
    ...
    invoke-direct {v2, p1}, Lio/grpc/internal/z$j;-><init>(Lio/grpc/h$a;)V
    ...
    invoke-direct {v1, p0, p1, v0}, Lio/grpc/internal/z$i;-><init>(Lio/grpc/internal/z;Lio/grpc/h$a;Lio/grpc/f1;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/grpc/internal/z$a;-><init>(Lio/grpc/internal/z;Lio/grpc/h$a;Lio/grpc/v0;)V
...
.method public final n(Lio/grpc/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Lio/grpc/internal/z;->o(Lio/grpc/h;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/grpc/internal/z;->f:Lio/grpc/h;
