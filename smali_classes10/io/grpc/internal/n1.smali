...
.field private final b:Lio/grpc/w0;
...
.field private final c:Lio/grpc/v0;
...
# direct methods
.method constructor <init>(Lio/grpc/internal/s;Lio/grpc/w0;Lio/grpc/v0;Lio/grpc/d;Lio/grpc/internal/n1$a;[Lio/grpc/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p2, p0, Lio/grpc/internal/n1;->b:Lio/grpc/w0;

    .line 5
    iput-object p3, p0, Lio/grpc/internal/n1;->c:Lio/grpc/v0;

    .line 6
    iput-object p4, p0, Lio/grpc/internal/n1;->d:Lio/grpc/d;
    ...
    iput-object p1, p0, Lio/grpc/internal/n1;->e:Lio/grpc/s;

    .line 8
    iput-object p5, p0, Lio/grpc/internal/n1;->f:Lio/grpc/internal/n1$a;

    .line 9
    iput-object p6, p0, Lio/grpc/internal/n1;->g:[Lio/grpc/l;
...
.method private c(Lio/grpc/internal/q;)V
    ...
    invoke-static {v1, v0}, Lcom/google/common/base/p;->v(ZLjava/lang/Object;)V
...
.method public a(Lio/grpc/v0;)V
    ...
    .line 3
    iget-object v0, p0, Lio/grpc/internal/n1;->c:Lio/grpc/v0;

    invoke-virtual {v0, p1}, Lio/grpc/v0;->l(Lio/grpc/v0;)V

    .line 4
    iget-object p1, p0, Lio/grpc/internal/n1;->e:Lio/grpc/s;
    ...
    iget-object v1, p0, Lio/grpc/internal/n1;->b:Lio/grpc/w0;

    iget-object v2, p0, Lio/grpc/internal/n1;->c:Lio/grpc/v0;

    iget-object v3, p0, Lio/grpc/internal/n1;->d:Lio/grpc/d;

    iget-object v4, p0, Lio/grpc/internal/n1;->g:[Lio/grpc/l;

    invoke-interface {v0, v1, v2, v3, v4}, Lio/grpc/internal/s;->d(Lio/grpc/w0;Lio/grpc/v0;Lio/grpc/d;[Lio/grpc/l;)Lio/grpc/internal/q;
    ...
    .line 6
    iget-object v1, p0, Lio/grpc/internal/n1;->e:Lio/grpc/s;

    invoke-virtual {v1, p1}, Lio/grpc/s;->k(Lio/grpc/s;)V
...
.method public b(Lio/grpc/f1;)V
    ...
    iget-object v1, p0, Lio/grpc/internal/n1;->g:[Lio/grpc/l;

    invoke-direct {v0, p1, v1}, Lio/grpc/internal/f0;-><init>(Lio/grpc/f1;[Lio/grpc/l;)V
