...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->t:Ljava/lang/Object;

    const/4 v0, 0x0

    .line 3
    iput-boolean v0, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->u:Z
...
.method private Dz()V
    ...
    .line 1
    iget-object v0, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->r:Ldagger/hilt/android/internal/managers/ViewComponentManager$FragmentContextWrapper;
    ...
    .line 4
    iput-object v1, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->r:Ldagger/hilt/android/internal/managers/ViewComponentManager$FragmentContextWrapper;
...
.method public final getContext()Landroid/content/Context;
    ...
    .line 2
    :cond_0
    invoke-direct {p0}, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->Dz()V
...
.method public final ms()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->s:Ldagger/hilt/android/internal/managers/g;

    if-nez v0, :cond_1

    .line 2
    iget-object v0, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->t:Ljava/lang/Object;

    monitor-enter v0

    .line 3
    :try_start_0
    iget-object v1, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->s:Ldagger/hilt/android/internal/managers/g;
    ...
    .line 5
    iput-object v1, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->s:Ldagger/hilt/android/internal/managers/g;
...
.method public final onAttach(Landroid/app/Activity;)V
    ...
    .line 9
    iget-boolean p1, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->u:Z

    if-nez p1, :cond_2

    .line 10
    iput-boolean v1, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->u:Z

    .line 11
    invoke-virtual {p0}, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->ms()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lnk0/s;

    move-object v0, p0

    check-cast v0, Lin/mohalla/sharechat/post/comment/sendComment/SendCommentFragment;

    invoke-interface {p1, v0}, Lnk0/s;->f0(Lin/mohalla/sharechat/post/comment/sendComment/SendCommentFragment;)V
...
.method public onAttach(Landroid/content/Context;)V
    ...
    .line 4
    iput-boolean p1, p0, Lin/mohalla/sharechat/post/comment/sendComment/Hilt_SendCommentFragment;->u:Z
