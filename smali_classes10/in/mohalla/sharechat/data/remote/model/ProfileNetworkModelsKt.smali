...
# direct methods
.method public static final toLocationInformation(Lin/mohalla/sharechat/data/remote/model/LocationResponse;)Ld02/b;
    .locals 11
    ...
    invoke-direct/range {v1 .. v10}, Ld02/b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILep0/k;)V
    ...
    invoke-virtual {v0, v1}, Ld02/b;->e(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Ld02/b;->i(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Ld02/b;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Ld02/b;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Ld02/b;->g(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0}, Ld02/b;->j(Ljava/lang/String;)V

    return-object v0
.end method

.method public static final toTrackableSet(Lcz1/i;)Ljava/util/Set;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lcz1/i;->m()Ljava/lang/String;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0}, Lcz1/i;->u()Ljava/lang/String;
    ...
    .line 4
    :cond_1
    invoke-virtual {p0}, Lcz1/i;->o()Ljava/lang/String;
    ...
    .line 5
    :cond_2
    invoke-virtual {p0}, Lcz1/i;->d()Ljava/lang/String;
    ...
    .line 6
    :cond_3
    invoke-virtual {p0}, Lcz1/i;->q()Ljava/lang/String;
    ...
    .line 7
    :cond_4
    invoke-virtual {p0}, Lcz1/i;->g()Ljava/lang/String;
    ...
    .line 8
    :cond_5
    invoke-virtual {p0}, Lcz1/i;->i()Ljava/lang/String;
    ...
    .line 9
    :cond_6
    invoke-virtual {p0}, Lcz1/i;->j()Ljava/lang/String;
    ...
    .line 10
    :cond_7
    invoke-virtual {p0}, Lcz1/i;->x()Ljava/lang/String;
    ...
    .line 11
    :cond_8
    invoke-virtual {p0}, Lcz1/i;->e()Ljava/lang/String;
    ...
    .line 12
    :cond_9
    invoke-virtual {p0}, Lcz1/i;->a()Ljava/lang/String;
    ...
    .line 13
    :cond_a
    invoke-virtual {p0}, Lcz1/i;->c()Ljava/lang/String;
    ...
    .line 14
    :cond_b
    invoke-virtual {p0}, Lcz1/i;->l()Ljava/lang/String;
    ...
    .line 15
    :cond_c
    iget-object v1, p0, Lcz1/i;->L:Ljava/lang/String;
    ...
    .line 17
    :cond_d
    invoke-virtual {p0}, Lcz1/i;->h()Ljava/lang/String;
    ...
    .line 18
    :cond_e
    invoke-virtual {p0}, Lcz1/i;->t()Ljava/lang/String;
    ...
    .line 19
    :cond_f
    invoke-virtual {p0}, Lcz1/i;->k()Ljava/lang/String;
    ...
    .line 20
    :cond_10
    invoke-virtual {p0}, Lcz1/i;->p()Ljava/lang/String;
    ...
    .line 21
    :cond_11
    invoke-virtual {p0}, Lcz1/i;->f()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_12

    const-string v1, "dm privacy"

    invoke-static {v0, v1}, Lin/mohalla/sharechat/data/remote/model/ProfileNetworkModelsKt;->toTrackableSet$add(Ljava/util/Set;Ljava/lang/String;)V

    .line 22
    :cond_12
    invoke-virtual {p0}, Lcz1/i;->r()Lsharechat/library/cvo/EducationProfessionOption;
    ...
    .line 23
    :cond_13
    invoke-virtual {p0}, Lcz1/i;->s()Lsharechat/library/cvo/EducationProfessionOption;

    move-result-object p0

    if-eqz p0, :cond_14

    const-string p0, "Profession"
...
.method public static final update(Lin/mohalla/sharechat/common/auth/LoggedInUser;Lcz1/i;Lin/mohalla/sharechat/common/language/AppLanguage;)Lin/mohalla/sharechat/common/auth/LoggedInUser;
    .locals 8
    ...
    .line 3
    invoke-virtual {p1}, Lcz1/i;->m()Ljava/lang/String;
    ...
    .line 4
    :cond_0
    invoke-virtual {p1}, Lcz1/i;->u()Ljava/lang/String;
    ...
    .line 7
    :cond_1
    invoke-virtual {p1}, Lcz1/i;->o()Ljava/lang/String;
    ...
    .line 10
    :cond_2
    invoke-virtual {p1}, Lcz1/i;->n()Ljava/lang/Integer;
    ...
    .line 12
    :cond_3
    invoke-virtual {p1}, Lcz1/i;->v()Ljava/lang/String;
    ...
    .line 13
    :cond_4
    invoke-virtual {p1}, Lcz1/i;->x()Ljava/lang/String;
    ...
    .line 14
    :cond_5
    invoke-virtual {p1}, Lcz1/i;->c()Ljava/lang/String;
    ...
    .line 15
    :cond_6
    iget-object v2, p1, Lcz1/i;->L:Ljava/lang/String;
    ...
    .line 17
    :cond_7
    invoke-virtual {p1}, Lcz1/i;->d()Ljava/lang/String;
    ...
    .line 18
    :cond_8
    invoke-virtual {p1}, Lcz1/i;->t()Ljava/lang/String;
    ...
    .line 19
    :cond_9
    invoke-virtual {p1}, Lcz1/i;->k()Ljava/lang/String;
    ...
    .line 20
    :cond_a
    invoke-virtual {p1}, Lcz1/i;->w()Ljava/lang/Long;
    ...
    .line 21
    :cond_b
    invoke-virtual {p1}, Lcz1/i;->g()Ljava/lang/String;
    ...
    .line 22
    :cond_c
    invoke-virtual {p1}, Lcz1/i;->y()Ljava/lang/Boolean;
    ...
    .line 24
    :cond_e
    iget-object v2, p1, Lcz1/i;->M:Ljava/lang/Long;
    ...
    invoke-virtual {v0, v2}, Lu40/a;->g(Ljava/lang/String;)V
    ...
    .line 30
    :cond_11
    iget-object v0, p1, Lcz1/i;->N:Ljava/lang/Long;
    ...
    .line 32
    :cond_12
    invoke-virtual {p1}, Lcz1/i;->b()Ljava/lang/String;
    ...
    .line 33
    :cond_13
    invoke-virtual {p1}, Lcz1/i;->l()Ljava/lang/String;
    ...
    .line 34
    :cond_14
    invoke-virtual {p1}, Lcz1/i;->q()Ljava/lang/String;
    ...
    .line 36
    :cond_16
    invoke-virtual {p1}, Lcz1/i;->e()Ljava/lang/String;
    ...
    .line 38
    :cond_18
    invoke-virtual {p1}, Lcz1/i;->h()Ljava/lang/String;
    ...
    .line 40
    :cond_1a
    invoke-virtual {p1}, Lcz1/i;->i()Ljava/lang/String;
    ...
    .line 41
    :cond_1b
    invoke-virtual {p1}, Lcz1/i;->j()Ljava/lang/String;
    ...
    .line 42
    :cond_1c
    invoke-virtual {p1}, Lcz1/i;->p()Ljava/lang/String;
    ...
    .line 43
    :cond_1d
    invoke-virtual {p1}, Lcz1/i;->f()Ljava/lang/String;
    ...
    .line 44
    :cond_1e
    iget-object p2, p1, Lcz1/i;->O:Ljava/lang/Boolean;
    ...
    .line 46
    :cond_1f
    iget-object p2, p1, Lcz1/i;->P:Ljava/lang/Boolean;
    ...
    .line 48
    :cond_20
    iget-object p1, p1, Lcz1/i;->Q:Ljava/lang/Boolean;
