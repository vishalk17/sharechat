...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 10
    :try_start_1
    invoke-static {v1}, Lokio/u;->l(Ljava/net/Socket;)Lokio/i0;
    ...
    .line 11
    invoke-static {v1}, Lokio/u;->h(Ljava/net/Socket;)Lokio/g0;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 29
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lr00/a;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lr00/a;)V
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-static {v2, p3, v1}, Lkotlin/text/l;->x(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Lokio/c;->J1()Z
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .line 2
    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/e;

    invoke-static {v6}, Lkotlin/jvm/internal/p;->f(Ljava/lang/Object;)V

    .line 3
    iget-object v7, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/d;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lokhttp3/internal/connection/Exchange;Lokio/e;Lokio/d;ZLokio/e;Lokio/d;)V
