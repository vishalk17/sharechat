...
.method public constructor <init>(Lokio/i0;)V
    ...
    .line 3
    invoke-interface {v0}, Lokio/e;->m1()Ljava/lang/String;
...
.method private final readCertificateList(Lokio/e;)Ljava/util/List;
    ...
    invoke-virtual {v5, v4}, Lokio/c;->U(Lokio/f;)Lokio/c;

    .line 8
    invoke-virtual {v5}, Lokio/c;->e2()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/d;Ljava/util/List;)V
    ...
    .line 4
    sget-object v4, Lokio/f;->e:Lokio/f$a;
    ...
    invoke-static/range {v4 .. v9}, Lokio/f$a;->g(Lokio/f$a;[BIIILjava/lang/Object;)Lokio/f;

    move-result-object v3

    invoke-virtual {v3}, Lokio/f;->d()Ljava/lang/String;

    move-result-object v3

    .line 5
    invoke-interface {p1, v3}, Lokio/d;->f1(Ljava/lang/String;)Lokio/d;

    move-result-object v3

    invoke-interface {v3, v1}, Lokio/d;->n0(I)Lokio/d;
    :try_end_0
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-interface {p1, v3, v4}, Lokio/d;->h0(J)Lokio/d;
    ...
    invoke-interface {p1, v5}, Lokio/d;->f1(Ljava/lang/String;)Lokio/d;

    move-result-object v5

    .line 7
    invoke-interface {v5, v4}, Lokio/d;->f1(Ljava/lang/String;)Lokio/d;
    ...
    .line 9
    invoke-interface {v4, v2}, Lokio/d;->n0(I)Lokio/d;
    ...
    invoke-interface {p1, v5, v6}, Lokio/d;->h0(J)Lokio/d;
    ...
    .line 14
    invoke-interface {v3, v4}, Lokio/d;->f1(Ljava/lang/String;)Lokio/d;
    ...
    .line 16
    invoke-interface {v3, v2}, Lokio/d;->n0(I)Lokio/d;
    ...
    invoke-interface {p1, v0}, Lokio/d;->f1(Ljava/lang/String;)Lokio/d;
    ...
    invoke-interface {v0, v3, v4}, Lokio/d;->h0(J)Lokio/d;
