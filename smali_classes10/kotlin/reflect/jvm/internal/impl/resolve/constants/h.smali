...
.method private final a(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/builtins/i;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;
    .locals 2
    ...
    .line 4
    invoke-virtual {p0, v1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/h;->c(Ljava/lang/Object;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/g;
    ...
    invoke-direct {p1, p2}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/h$b;-><init>(Lkotlin/reflect/jvm/internal/impl/builtins/i;)V

    new-instance p2, Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;

    invoke-direct {p2, v0, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;-><init>(Ljava/util/List;Lr00/l;)V
...
# virtual methods
.method public final b(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/e0;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/h$a;-><init>(Lkotlin/reflect/jvm/internal/impl/types/e0;)V

    invoke-direct {v0, p1, v1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;-><init>(Ljava/util/List;Lr00/l;)V
...
.method public final c(Ljava/lang/Object;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/g;
    ...
    invoke-direct {v0, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/u;-><init>(S)V
    ...
    invoke-direct {v0, v1, v2}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/r;-><init>(J)V
    ...
    invoke-direct {v0, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/v;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lkotlin/collections/l;->p0([B)Ljava/util/List;

    move-result-object p1

    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/i;->BYTE:Lkotlin/reflect/jvm/internal/impl/builtins/i;

    invoke-direct {p0, p1, v0}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/h;->a(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/builtins/i;)Lkotlin/reflect/jvm/internal/impl/resolve/constants/b;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->w0([S)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->t0([I)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->u0([J)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->q0([C)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->s0([F)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->r0([D)Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/collections/l;->x0([Z)Ljava/util/List;
    ...
    invoke-direct {v0}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/s;-><init>()V
