...
# instance fields
.field private final b:Lretrofit2/s;

.field private final c:[Ljava/lang/Object;

.field private final d:Lokhttp3/Call$Factory;

.field private final e:Lretrofit2/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lretrofit2/f<",
...
# direct methods
.method constructor <init>(Lretrofit2/s;[Ljava/lang/Object;Lokhttp3/Call$Factory;Lretrofit2/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lretrofit2/n;->b:Lretrofit2/s;

    .line 3
    iput-object p2, p0, Lretrofit2/n;->c:[Ljava/lang/Object;

    .line 4
    iput-object p3, p0, Lretrofit2/n;->d:Lokhttp3/Call$Factory;
...
.method private b()Lokhttp3/Call;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/n;->d:Lokhttp3/Call$Factory;

    iget-object v1, p0, Lretrofit2/n;->b:Lretrofit2/s;

    iget-object v2, p0, Lretrofit2/n;->c:[Ljava/lang/Object;

    invoke-virtual {v1, v2}, Lretrofit2/s;->a([Ljava/lang/Object;)Lokhttp3/Request;
...
.method private c()Lokhttp3/Call;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/n;->g:Lokhttp3/Call;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/n;->b()Lokhttp3/Call;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/n;->g:Lokhttp3/Call;
    :try_end_0
...
.method public S(Lretrofit2/d;)V
    ...
    iput-object v2, p0, Lretrofit2/n;->g:Lokhttp3/Call;
    :try_end_1
...
.method public a()Lretrofit2/n;
    ...
    iget-object v3, p0, Lretrofit2/n;->d:Lokhttp3/Call$Factory;

    iget-object v4, p0, Lretrofit2/n;->e:Lretrofit2/f;

    invoke-direct {v0, v1, v2, v3, v4}, Lretrofit2/n;-><init>(Lretrofit2/s;[Ljava/lang/Object;Lokhttp3/Call$Factory;Lretrofit2/f;)V
...
.method d(Lokhttp3/Response;)Lretrofit2/t;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, v3, v4}, Lretrofit2/n$c;-><init>(Lokhttp3/MediaType;J)V
    ...
    invoke-direct {v1, v0}, Lretrofit2/n$b;-><init>(Lokhttp3/ResponseBody;)V
    ...
    .line 8
    invoke-static {v0, p1}, Lretrofit2/t;->h(Ljava/lang/Object;Lokhttp3/Response;)Lretrofit2/t;
    ...
    .line 9
    invoke-virtual {v1}, Lretrofit2/n$b;->b()V
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/y;->a(Lokhttp3/ResponseBody;)Lokhttp3/ResponseBody;

    move-result-object v1

    .line 14
    invoke-static {v1, p1}, Lretrofit2/t;->c(Lokhttp3/ResponseBody;Lokhttp3/Response;)Lretrofit2/t;
...
.method public execute()Lretrofit2/t;
    ...
    .line 4
    invoke-direct {p0}, Lretrofit2/n;->c()Lokhttp3/Call;
    ...
    invoke-virtual {p0, v0}, Lretrofit2/n;->d(Lokhttp3/Response;)Lretrofit2/t;
