...
.method protected final g3(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 2
    invoke-interface {p0, p1}, Lcom/google/android/gms/internal/ads/os;->s1(Z)V

    goto :goto_0

    .line 3
    :cond_1
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/os;->zzh()V

    goto :goto_0

    .line 4
    :cond_2
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/os;->zzg()V

    goto :goto_0

    .line 5
    :cond_3
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/os;->zzf()V

    goto :goto_0

    .line 6
    :cond_4
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/os;->zze()V
