...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    const-string v3, "PRINT_LOGS_WHEN_NO_CALLBACKS_DEFINED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;->PRINT_LOGS_WHEN_NO_CALLBACKS_DEFINED:Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    .line 3
    new-instance v3, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    const-string v5, "PRINT_LOGS_WHEN_GLOBAL_CALLBACK_NOT_DEFINED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;->PRINT_LOGS_WHEN_GLOBAL_CALLBACK_NOT_DEFINED:Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    .line 4
    new-instance v5, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    const-string v7, "PRINT_LOGS_WHEN_SESSION_CALLBACK_NOT_DEFINED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;->PRINT_LOGS_WHEN_SESSION_CALLBACK_NOT_DEFINED:Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    .line 5
    new-instance v7, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    const-string v9, "NEVER_PRINT_LOGS"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;->NEVER_PRINT_LOGS:Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;
    ...
    .line 6
    sput-object v9, Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;->$VALUES:[Lcom/arthenica/ffmpegkit/LogRedirectionStrategy;
