...
.method public b(Landroidx/databinding/f;Landroid/view/View;I)Landroidx/databinding/ViewDataBinding;
    ...
    .line 4
    new-instance p3, Ld80/f4;

    invoke-direct {p3, p1, p2}, Ld80/f4;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for viewholder_chat_room_battle_timer is invalid. Received: "
    ...
    .line 7
    new-instance p3, Ld80/b4;

    invoke-direct {p3, p1, p2}, Ld80/b4;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for viewholder_battle_mode_invite is invalid. Received: "
    ...
    .line 10
    new-instance p3, Ld80/b3;

    invoke-direct {p3, p1, p2}, Ld80/b3;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for item_send_comment_fragment_icon is invalid. Received: "
    ...
    .line 13
    new-instance p3, Ld80/t0;

    invoke-direct {p3, p1, p2}, Ld80/t0;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for fragment_battle_ongoing is invalid. Received: "
    ...
    .line 16
    new-instance p3, Ld80/r0;

    invoke-direct {p3, p1, p2}, Ld80/r0;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for fragment_battle_mode_start is invalid. Received: "
    ...
    .line 19
    new-instance p3, Ld80/p0;

    invoke-direct {p3, p1, p2}, Ld80/p0;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for fragment_battle_invite_single_listing is invalid. Received: "
    ...
    .line 22
    new-instance p3, Ld80/w;

    invoke-direct {p3, p1, p2}, Ld80/w;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for bottomsheet_battle_mode_invite is invalid. Received: "
    ...
    .line 25
    new-instance p3, Ld80/u;

    invoke-direct {p3, p1, p2}, Ld80/u;-><init>(Landroidx/databinding/f;Landroid/view/View;)V
    ...
    const-string p3, "The tag for bottomsheet_battle_mode_entry is invalid. Received: "
