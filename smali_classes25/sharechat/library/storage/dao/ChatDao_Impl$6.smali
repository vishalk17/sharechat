.class Lsharechat/library/storage/dao/ChatDao_Impl$6;
...
.method constructor <init>(Lsharechat/library/storage/dao/ChatDao_Impl;Landroidx/room/w0;)V
    ...
    .line 1
    iput-object p1, p0, Lsharechat/library/storage/dao/ChatDao_Impl$6;->this$0:Lsharechat/library/storage/dao/ChatDao_Impl;
...
.method public bridge synthetic bind(Ll2/j;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lsharechat/library/storage/dao/ChatDao_Impl$6;->bind(Ll2/j;Lsharechat/library/cvo/ChatListEntity;)V

    return-void
.end method

.method public bind(Ll2/j;Lsharechat/library/cvo/ChatListEntity;)V
    .locals 4
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `chat_list_entity` SET `chatId` = ?,`chatStatus` = ?,`recipientId` = ?,`chatTitle` = ?,`chatPreviewText` = ?,`chatProfileUrl` = ?,`lastMessageTimeInMs` = ?,`numUnreadMessage` = ?,`lastOffset` = ?,`listType` = ?,`deliveryStatus` = ? WHERE `chatId` = ?"
