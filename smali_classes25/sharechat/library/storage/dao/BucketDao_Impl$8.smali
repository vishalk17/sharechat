.class Lsharechat/library/storage/dao/BucketDao_Impl$8;
...
.method constructor <init>(Lsharechat/library/storage/dao/BucketDao_Impl;Landroidx/room/w0;)V
    ...
    .line 1
    iput-object p1, p0, Lsharechat/library/storage/dao/BucketDao_Impl$8;->this$0:Lsharechat/library/storage/dao/BucketDao_Impl;
...
.method public bridge synthetic bind(Ll2/j;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lsharechat/library/storage/dao/BucketDao_Impl$8;->bind(Ll2/j;Lsharechat/library/cvo/BucketEntity;)V
...
.method public bind(Ll2/j;Lsharechat/library/cvo/BucketEntity;)V
    ...
    .line 30
    iget-object v0, p0, Lsharechat/library/storage/dao/BucketDao_Impl$8;->this$0:Lsharechat/library/storage/dao/BucketDao_Impl;
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `buckets` SET `id` = ?,`bucketName` = ?,`thumbByte` = ?,`punchLine` = ?,`score` = ?,`isAdult` = ?,`language` = ?,`bucketScore` = ?,`exploreScore` = ?,`isNewBucket` = ?,`isActive` = ?,`ugcBlock` = ?,`backgroundColor` = ?,`bgImage` = ?,`bgThumb` = ?,`iconUrl` = ?,`isCategory` = ?,`memer` = ?,`isCvBucket` = ?,`webCardObject` = ?,`tagRowsToShow` = ? WHERE `id` = ?"
