.class public final Lsharechat/library/generic/items/o;
.super Ljava/lang/Object;
.source "SourceFile"


# direct methods
.method public static final a(Lsharechat/library/cvo/generic/LazyRowComponent;Landroidx/compose/ui/h;Landroidx/compose/foundation/layout/p;Landroidx/compose/foundation/layout/y0;Landroidx/compose/foundation/layout/j;Landroidx/compose/foundation/lazy/g;Landroidx/compose/runtime/i;II)V
    .locals 32
    ...
    const-string v3, "sharechat.library.generic.items.LazyRowComponentRender (LazyRowComponentItem.kt:35)"
    ...
    .line 27
    :cond_1b
    new-instance v13, Lsharechat/library/generic/items/o$d;

    invoke-direct {v13, v3}, Lsharechat/library/generic/items/o$d;-><init>(Landroidx/compose/runtime/t0;)V
    ...
    .line 37
    invoke-virtual/range {p0 .. p0}, Lsharechat/library/cvo/generic/LazyRowComponent;->getSpan()Ljava/lang/Integer;
    ...
    invoke-static {v0, v12, v12, v15}, Lkotlin/collections/t;->e1(Ljava/lang/Iterable;IIZ)Ljava/util/List;
    ...
    .line 42
    new-instance v15, Lsharechat/library/generic/items/o$c;

    invoke-direct {v15, v0, v2, v13, v12}, Lsharechat/library/generic/items/o$c;-><init>(Ljava/util/List;Lsharechat/library/cvo/generic/LazyRowComponent;Lsharechat/library/generic/a;Ljava/lang/String;)V

    .line 43
    :try_start_0
    sget-object v17, Li00/p;->b:Li00/p$a;
    :try_end_0
    ...
    .line 44
    :try_start_1
    invoke-virtual/range {p0 .. p0}, Lsharechat/library/cvo/generic/LazyRowComponent;->getContentPadding()Lsharechat/library/cvo/generic/PaddingComponent;
    ...
    :try_start_2
    invoke-static {v4, v6, v5, v6}, Lsharechat/library/generic/items/y;->i(Lsharechat/library/cvo/generic/PaddingComponent;Landroidx/compose/foundation/layout/r0;ILjava/lang/Object;)Landroidx/compose/foundation/layout/r0;

    move-result-object v4

    .line 45
    invoke-virtual/range {p0 .. p0}, Lsharechat/library/cvo/generic/LazyRowComponent;->getVerticalAlignment()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lsharechat/library/generic/items/s;->b(Ljava/lang/String;)Landroidx/compose/ui/a$c;

    move-result-object v5

    .line 46
    invoke-virtual/range {p0 .. p0}, Lsharechat/library/cvo/generic/LazyRowComponent;->getSpaceBy()Ljava/lang/Float;
    ...
    invoke-static {v7, v8}, Lsharechat/library/generic/items/y;->d(Ljava/lang/Float;F)F
    ...
    .line 48
    invoke-virtual/range {p0 .. p0}, Lsharechat/library/cvo/generic/LazyRowComponent;->getHorizontalArrangement()Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Lsharechat/library/generic/items/s;->c(Ljava/lang/String;Ljava/lang/Float;)Landroidx/compose/foundation/layout/e$d;
    ...
    .line 49
    new-instance v18, Lsharechat/library/generic/items/o$a;
    ...
    invoke-direct/range {p1 .. p6}, Lsharechat/library/generic/items/o$a;-><init>(Lsharechat/library/cvo/generic/LazyRowComponent;Ljava/util/List;Landroidx/compose/ui/h;ZLandroidx/compose/runtime/t0;)V
    :try_end_3
    ...
    invoke-virtual {v4, v8, v0, v3}, Lsharechat/library/generic/a;->a0(Lsharechat/library/cvo/WebCardObject;Ljava/lang/String;Ljava/lang/String;)V

    .line 55
    :goto_1c
    invoke-virtual/range {p0 .. p0}, Lsharechat/library/cvo/generic/LazyRowComponent;->getPaginationBufferSize()Ljava/lang/Integer;
    ...
    .line 57
    invoke-static {v6, v5, v1, v7}, Lsharechat/library/generic/items/j;->a(Landroidx/compose/foundation/lazy/f0;Lr00/l;Landroidx/compose/runtime/i;I)V
    ...
    :cond_21
    new-instance v10, Lsharechat/library/generic/items/o$b;
    ...
    invoke-direct/range {v1 .. v9}, Lsharechat/library/generic/items/o$b;-><init>(Lsharechat/library/cvo/generic/LazyRowComponent;Landroidx/compose/ui/h;Landroidx/compose/foundation/layout/p;Landroidx/compose/foundation/layout/y0;Landroidx/compose/foundation/layout/j;Landroidx/compose/foundation/lazy/g;II)V
...
.method public static final synthetic d(Landroidx/compose/runtime/t0;)J
    ...
    .line 1
    invoke-static {p0}, Lsharechat/library/generic/items/o;->b(Landroidx/compose/runtime/t0;)J
...
.method public static final synthetic e(Landroidx/compose/runtime/t0;J)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lsharechat/library/generic/items/o;->c(Landroidx/compose/runtime/t0;J)V
