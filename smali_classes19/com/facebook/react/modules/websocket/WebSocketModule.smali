...
.field private mCookieHandler:Lcd/e;
...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;)V
    ...
    invoke-direct {v0, p1}, Lcd/e;-><init>(Lcom/facebook/react/bridge/ReactContext;)V

    iput-object v0, p0, Lcom/facebook/react/modules/websocket/WebSocketModule;->mCookieHandler:Lcd/e;
...
.method private getCookie(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2
    iget-object v1, p0, Lcom/facebook/react/modules/websocket/WebSocketModule;->mCookieHandler:Lcd/e;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {v1, v0, v2}, Lcd/e;->get(Ljava/net/URI;Ljava/util/Map;)Ljava/util/Map;
...
.method public close(DLjava/lang/String;D)V
    ...
    invoke-static {p3, p2, p1}, Lia/a;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public ping(D)V
    ...
    invoke-interface {p2, v0}, Lokhttp3/WebSocket;->send(Lmt0/f;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendBinary(Ljava/lang/String;D)V
    ...
    invoke-virtual {v0, p1}, Lmt0/f$a;->a(Ljava/lang/String;)Lmt0/f;

    move-result-object p1

    .line 14
    invoke-interface {p3, p1}, Lokhttp3/WebSocket;->send(Lmt0/f;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendBinary(Lmt0/f;I)V
    .locals 3
    ...
    :cond_0
    :try_start_0
    invoke-interface {v0, p1}, Lokhttp3/WebSocket;->send(Lmt0/f;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
