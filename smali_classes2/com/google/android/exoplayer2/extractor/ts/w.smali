...
.field private e:Lcom/google/android/exoplayer2/util/s0;
...
.method public constructor <init>(Lcom/google/android/exoplayer2/extractor/ts/m;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;
...
.method private d(Lcom/google/android/exoplayer2/util/e0;[BI)Z
    .locals 3
    ...
    invoke-virtual {p1, p2, v2, v0}, Lcom/google/android/exoplayer2/util/e0;->j([BII)V
...
.method private e()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;
    ...
    invoke-static {v2, v0}, Lcom/google/android/exoplayer2/util/u;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 7
    iget-object v5, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;

    const/4 v6, 0x5

    invoke-virtual {v5, v6}, Lcom/google/android/exoplayer2/util/d0;->r(I)V

    .line 8
    iget-object v5, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v5}, Lcom/google/android/exoplayer2/util/d0;->g()Z
...
.method private f()V
    ...
    invoke-virtual {v5, v7}, Lcom/google/android/exoplayer2/util/d0;->h(I)I
    ...
    invoke-virtual {v5, v1}, Lcom/google/android/exoplayer2/util/d0;->r(I)V

    .line 13
    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;
    ...
    .line 14
    iget-object v2, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v2, v6}, Lcom/google/android/exoplayer2/util/d0;->r(I)V

    .line 15
    iget-object v2, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v2, v7}, Lcom/google/android/exoplayer2/util/d0;->h(I)I
    ...
    .line 19
    iget-object v2, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->e:Lcom/google/android/exoplayer2/util/s0;

    invoke-virtual {v2, v0, v1}, Lcom/google/android/exoplayer2/util/s0;->b(J)J
    ...
    .line 21
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->e:Lcom/google/android/exoplayer2/util/s0;

    invoke-virtual {v0, v3, v4}, Lcom/google/android/exoplayer2/util/s0;->b(J)J
...
.method public a(Lcom/google/android/exoplayer2/util/s0;Lcom/google/android/exoplayer2/extractor/k;Lcom/google/android/exoplayer2/extractor/ts/i0$d;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->e:Lcom/google/android/exoplayer2/util/s0;

    .line 2
    iget-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->a:Lcom/google/android/exoplayer2/extractor/ts/m;

    invoke-interface {p1, p2, p3}, Lcom/google/android/exoplayer2/extractor/ts/m;->f(Lcom/google/android/exoplayer2/extractor/k;Lcom/google/android/exoplayer2/extractor/ts/i0$d;)V
...
.method public final b()V
    ...
    invoke-interface {v0}, Lcom/google/android/exoplayer2/extractor/ts/m;->b()V

    return-void
.end method

.method public final c(Lcom/google/android/exoplayer2/util/e0;I)V
    .locals 8
    ...
    invoke-interface {v0}, Lcom/google/android/exoplayer2/extractor/ts/m;->d()V
    ...
    invoke-virtual {p1, v5}, Lcom/google/android/exoplayer2/util/e0;->O(I)V

    .line 14
    :cond_6
    iget-object v5, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->a:Lcom/google/android/exoplayer2/extractor/ts/m;

    invoke-interface {v5, p1}, Lcom/google/android/exoplayer2/extractor/ts/m;->c(Lcom/google/android/exoplayer2/util/e0;)V
    ...
    .line 21
    iget-object v6, p0, Lcom/google/android/exoplayer2/extractor/ts/w;->b:Lcom/google/android/exoplayer2/util/d0;

    iget-object v6, v6, Lcom/google/android/exoplayer2/util/d0;->a:[B

    invoke-direct {p0, p1, v6, v0}, Lcom/google/android/exoplayer2/extractor/ts/w;->d(Lcom/google/android/exoplayer2/util/e0;[BI)Z
    ...
    .line 22
    invoke-direct {p0, p1, v0, v6}, Lcom/google/android/exoplayer2/extractor/ts/w;->d(Lcom/google/android/exoplayer2/util/e0;[BI)Z
    ...
    invoke-interface {v0, v5, v6, p2}, Lcom/google/android/exoplayer2/extractor/ts/m;->e(JI)V
