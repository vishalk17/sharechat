...
# instance fields
.field private final a:Lcom/google/android/exoplayer2/extractor/c0;
...
.field private final e:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Lcom/google/android/exoplayer2/util/z$a;",
            ">;"
        }
    .end annotation
.end field

.field private final f:Lcom/google/android/exoplayer2/util/f0;
...
# direct methods
.method public constructor <init>(Lcom/google/android/exoplayer2/extractor/c0;ZZ)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->a:Lcom/google/android/exoplayer2/extractor/c0;
    ...
    iput-object p2, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;
...
.method private d(I)V
    ...
    iget-wide v4, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->p:J
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->a:Lcom/google/android/exoplayer2/extractor/c0;
...
.method public a([BII)V
    ...
    .line 6
    iget-object v2, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->g:[B

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4, v1}, Lcom/google/android/exoplayer2/util/f0;->i([BII)V

    .line 7
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    const/16 v2, 0x8

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/f0;->b(I)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/f0;->k()V

    .line 9
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    invoke-virtual {v1, v7}, Lcom/google/android/exoplayer2/util/f0;->e(I)I
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/f0;->l(I)V

    .line 11
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/f0;->c()Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/f0;->h()I
    ...
    check-cast v1, Lcom/google/android/exoplayer2/util/z$a;

    .line 23
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->d:Landroid/util/SparseArray;

    iget v5, v1, Lcom/google/android/exoplayer2/util/z$a;->b:I
    ...
    check-cast v9, Lcom/google/android/exoplayer2/util/z$b;

    .line 24
    iget-boolean v3, v9, Lcom/google/android/exoplayer2/util/z$b;->h:Z

    if-eqz v3, :cond_9

    .line 25
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/f0;->b(I)Z
    ...
    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/f0;->l(I)V

    .line 27
    :cond_9
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    iget v5, v9, Lcom/google/android/exoplayer2/util/z$b;->j:I

    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/f0;->b(I)Z
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/f0;->e(I)I

    move-result v12

    .line 29
    iget-boolean v3, v9, Lcom/google/android/exoplayer2/util/z$b;->i:Z
    ...
    .line 32
    iget-object v6, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/f0;

    invoke-virtual {v6, v5}, Lcom/google/android/exoplayer2/util/f0;->b(I)Z
    ...
    invoke-virtual {v6}, Lcom/google/android/exoplayer2/util/f0;->d()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/f0;->c()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/f0;->h()I
    ...
    .line 37
    :goto_3
    iget v2, v9, Lcom/google/android/exoplayer2/util/z$b;->k:I
    ...
    iget v3, v9, Lcom/google/android/exoplayer2/util/z$b;->l:I

    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/f0;->b(I)Z
    ...
    .line 40
    iget-boolean v1, v1, Lcom/google/android/exoplayer2/util/z$a;->c:Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/f0;->g()I
    ...
    .line 43
    iget-boolean v2, v9, Lcom/google/android/exoplayer2/util/z$b;->m:Z
    ...
    invoke-virtual/range {v8 .. v22}, Lcom/google/android/exoplayer2/extractor/ts/p$b$a;->e(Lcom/google/android/exoplayer2/util/z$b;IIIIZZZZIIIII)V
...
.method public e(Lcom/google/android/exoplayer2/util/z$a;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->e:Landroid/util/SparseArray;

    iget v1, p1, Lcom/google/android/exoplayer2/util/z$a;->a:I
...
.method public f(Lcom/google/android/exoplayer2/util/z$b;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->d:Landroid/util/SparseArray;

    iget v1, p1, Lcom/google/android/exoplayer2/util/z$b;->d:I
