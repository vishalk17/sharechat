...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/google/android/exoplayer2/y1$b;)V
    ...
    iput-object p2, p0, Lcom/google/android/exoplayer2/y1;->d:Landroid/media/AudioManager;

    const/4 p3, 0x3

    .line 7
    iput p3, p0, Lcom/google/android/exoplayer2/y1;->f:I

    .line 8
    invoke-static {p2, p3}, Lcom/google/android/exoplayer2/y1;->f(Landroid/media/AudioManager;I)I

    move-result p3

    iput p3, p0, Lcom/google/android/exoplayer2/y1;->g:I

    .line 9
    iget p3, p0, Lcom/google/android/exoplayer2/y1;->f:I

    invoke-static {p2, p3}, Lcom/google/android/exoplayer2/y1;->e(Landroid/media/AudioManager;I)Z

    move-result p2

    iput-boolean p2, p0, Lcom/google/android/exoplayer2/y1;->h:Z

    .line 10
    new-instance p2, Lcom/google/android/exoplayer2/y1$c;

    const/4 p3, 0x0

    invoke-direct {p2, p0, p3}, Lcom/google/android/exoplayer2/y1$c;-><init>(Lcom/google/android/exoplayer2/y1;Lcom/google/android/exoplayer2/y1$a;)V
    ...
    .line 13
    iput-object p2, p0, Lcom/google/android/exoplayer2/y1;->e:Lcom/google/android/exoplayer2/y1$c;
    :try_end_0
    ...
    .line 14
    invoke-static {p2, p3, p1}, Lcom/google/android/exoplayer2/util/u;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method static synthetic b(Lcom/google/android/exoplayer2/y1;)V
    ...
    .line 1
    invoke-direct {p0}, Lcom/google/android/exoplayer2/y1;->i()V
...
.method private static e(Landroid/media/AudioManager;I)Z
    ...
    .line 3
    :cond_0
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/y1;->f(Landroid/media/AudioManager;I)I
...
.method private static f(Landroid/media/AudioManager;I)I
    ...
    invoke-static {v2, v1, v0}, Lcom/google/android/exoplayer2/util/u;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private i()V
    ...
    invoke-static {v0, v1}, Lcom/google/android/exoplayer2/y1;->f(Landroid/media/AudioManager;I)I
    ...
    invoke-static {v1, v2}, Lcom/google/android/exoplayer2/y1;->e(Landroid/media/AudioManager;I)Z
    ...
    invoke-interface {v2, v0, v1}, Lcom/google/android/exoplayer2/y1$b;->o(IZ)V
...
.method public g()V
    ...
    .line 3
    invoke-static {v1, v2, v0}, Lcom/google/android/exoplayer2/util/u;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public h(I)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/exoplayer2/y1$b;->h(I)V
