...
.method public close(DLjava/lang/String;D)V
    ...
    invoke-static {p3, p2, p1}, Lf5/a;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public connect(Ljava/lang/String;Lcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/ReadableMap;D)V
    ...
    invoke-static {v7, v6}, Lf5/a;->A(Ljava/lang/String;Ljava/lang/String;)V
...
.method public ping(D)V
    ...
    invoke-interface {p2, v0}, Lokhttp3/WebSocket;->send(Lokio/f;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendBinary(Ljava/lang/String;D)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, Lokio/f;->f(Ljava/lang/String;)Lokio/f;

    move-result-object p1

    invoke-interface {p3, p1}, Lokhttp3/WebSocket;->send(Lokio/f;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendBinary(Lokio/f;I)V
    .locals 3
    ...
    :cond_0
    :try_start_0
    invoke-interface {v0, p1}, Lokhttp3/WebSocket;->send(Lokio/f;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
