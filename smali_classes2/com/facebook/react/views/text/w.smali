...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/facebook/react/views/text/w$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/facebook/react/views/text/w;->a:Landroid/text/TextPaint;
    ...
    sput-object v0, Lcom/facebook/react/views/text/w;->b:Ljava/lang/Object;
    ...
    sput-object v0, Lcom/facebook/react/views/text/w;->c:Landroid/util/LruCache;
...
.method private static a(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableArray;Landroid/text/SpannableStringBuilder;Ljava/util/List;)V
    ...
    .line 4
    new-instance v6, Lcom/facebook/react/views/text/s;
    ...
    invoke-direct {v6, v7}, Lcom/facebook/react/views/text/s;-><init>(Lcom/facebook/react/uimanager/c0;)V
    ...
    iget-object v8, v6, Lcom/facebook/react/views/text/s;->k:Lcom/facebook/react/views/text/x;

    invoke-static {v7, v8}, Lcom/facebook/react/views/text/x;->apply(Ljava/lang/String;Lcom/facebook/react/views/text/x;)Ljava/lang/String;
    ...
    .line 13
    new-instance v6, Lcom/facebook/react/views/text/w$a;
    ...
    new-instance v11, Lcom/facebook/react/views/text/v;

    float-to-int v5, v5

    float-to-int v4, v4

    invoke-direct {v11, v9, v5, v4}, Lcom/facebook/react/views/text/v;-><init>(III)V

    invoke-direct {v6, v7, v10, v11}, Lcom/facebook/react/views/text/w$a;-><init>(IILcom/facebook/react/views/text/i;)V
    ...
    .line 17
    iget-boolean v4, v6, Lcom/facebook/react/views/text/s;->b:Z

    if-eqz v4, :cond_1

    .line 18
    new-instance v4, Lcom/facebook/react/views/text/w$a;

    new-instance v10, Lcom/facebook/react/views/text/ReactForegroundColorSpan;

    iget v11, v6, Lcom/facebook/react/views/text/s;->d:I

    invoke-direct {v10, v11}, Lcom/facebook/react/views/text/ReactForegroundColorSpan;-><init>(I)V

    invoke-direct {v4, v5, v7, v10}, Lcom/facebook/react/views/text/w$a;-><init>(IILcom/facebook/react/views/text/i;)V

    invoke-interface {v0, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 19
    :cond_1
    iget-boolean v4, v6, Lcom/facebook/react/views/text/s;->e:Z
    ...
    iget v11, v6, Lcom/facebook/react/views/text/s;->f:I
    ...
    .line 22
    invoke-virtual {v6}, Lcom/facebook/react/views/text/s;->g()F
    ...
    iget v11, v6, Lcom/facebook/react/views/text/s;->g:I
    ...
    .line 27
    iget v4, v6, Lcom/facebook/react/views/text/s;->r:I

    const/4 v10, -0x1

    if-ne v4, v10, :cond_5

    iget v4, v6, Lcom/facebook/react/views/text/s;->s:I

    if-ne v4, v10, :cond_5

    iget-object v4, v6, Lcom/facebook/react/views/text/s;->t:Ljava/lang/String;
    ...
    iget v11, v6, Lcom/facebook/react/views/text/s;->r:I

    iget v12, v6, Lcom/facebook/react/views/text/s;->s:I

    iget-object v13, v6, Lcom/facebook/react/views/text/s;->u:Ljava/lang/String;

    iget-object v14, v6, Lcom/facebook/react/views/text/s;->t:Ljava/lang/String;
    ...
    invoke-direct {v4, v5, v7, v1}, Lcom/facebook/react/views/text/w$a;-><init>(IILcom/facebook/react/views/text/i;)V
    ...
    .line 31
    :goto_2
    iget-boolean v1, v6, Lcom/facebook/react/views/text/s;->p:Z

    if-eqz v1, :cond_6

    .line 32
    new-instance v1, Lcom/facebook/react/views/text/w$a;
    ...
    invoke-direct {v1, v5, v7, v4}, Lcom/facebook/react/views/text/w$a;-><init>(IILcom/facebook/react/views/text/i;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 33
    :cond_6
    iget-boolean v1, v6, Lcom/facebook/react/views/text/s;->q:Z
    ...
    .line 35
    :cond_7
    iget v1, v6, Lcom/facebook/react/views/text/s;->l:F
    ...
    iget v1, v6, Lcom/facebook/react/views/text/s;->m:F
    ...
    new-instance v4, Lcom/facebook/react/views/text/r;

    iget v10, v6, Lcom/facebook/react/views/text/s;->l:F

    iget v11, v6, Lcom/facebook/react/views/text/s;->m:F

    iget v12, v6, Lcom/facebook/react/views/text/s;->n:F

    iget v13, v6, Lcom/facebook/react/views/text/s;->o:I

    invoke-direct {v4, v10, v11, v12, v13}, Lcom/facebook/react/views/text/r;-><init>(FFFI)V
    ...
    .line 37
    :cond_9
    invoke-virtual {v6}, Lcom/facebook/react/views/text/s;->c()F
    ...
    new-instance v4, Lcom/facebook/react/views/text/j;

    invoke-direct {v4, v9}, Lcom/facebook/react/views/text/j;-><init>(I)V
...
.method private static b(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/views/text/o;)Landroid/text/Spannable;
    .locals 3
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/facebook/react/views/text/w;->a(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableArray;Landroid/text/SpannableStringBuilder;Ljava/util/List;)V
    ...
    check-cast v1, Lcom/facebook/react/views/text/w$a;

    .line 5
    invoke-virtual {v1, v0, p1}, Lcom/facebook/react/views/text/w$a;->a(Landroid/text/SpannableStringBuilder;I)V
...
.method public static c(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/views/text/o;)Landroid/text/Spannable;
    .locals 3
    ...
    .line 2
    sget-object v1, Lcom/facebook/react/views/text/w;->b:Ljava/lang/Object;

    monitor-enter v1

    .line 3
    :try_start_0
    sget-object v2, Lcom/facebook/react/views/text/w;->c:Landroid/util/LruCache;
    ...
    .line 6
    invoke-static {p0, p1, p2}, Lcom/facebook/react/views/text/w;->b(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/views/text/o;)Landroid/text/Spannable;
    ...
    .line 8
    :try_start_1
    sget-object p1, Lcom/facebook/react/views/text/w;->c:Landroid/util/LruCache;
...
.method public static d(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/bridge/ReadableMap;FLcom/facebook/yoga/n;FLcom/facebook/yoga/n;Lcom/facebook/react/views/text/o;[I)J
    .locals 18
    ...
    .line 1
    sget-object v3, Lcom/facebook/react/views/text/w;->a:Landroid/text/TextPaint;
    ...
    .line 2
    invoke-static {v2, v4, v5}, Lcom/facebook/react/views/text/w;->c(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/views/text/o;)Landroid/text/Spannable;
    ...
    invoke-static {v2}, Lcom/facebook/react/views/text/s;->j(Ljava/lang/String;)I
    ...
    .line 6
    :goto_0
    sget-object v5, Lcom/facebook/yoga/n;->UNDEFINED:Lcom/facebook/yoga/n;
    ...
    .line 37
    const-class v5, Lcom/facebook/react/views/text/v;
    ...
    .line 39
    const-class v6, Lcom/facebook/react/views/text/v;
    ...
    check-cast v2, [Lcom/facebook/react/views/text/v;
    ...
    :cond_d
    :goto_9
    invoke-virtual {v8}, Lcom/facebook/react/views/text/v;->c()I

    move-result v10

    .line 48
    invoke-virtual {v8}, Lcom/facebook/react/views/text/v;->a()I
