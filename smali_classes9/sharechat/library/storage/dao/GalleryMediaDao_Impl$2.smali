...
.method public bridge synthetic bind(Ll6/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lsharechat/library/storage/dao/GalleryMediaDao_Impl$2;->bind(Ll6/f;Lsharechat/library/cvo/GalleryMediaEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `gallery_media` SET `mediaType` = ?,`mediaPath` = ?,`mediaUri` = ?,`lastModifiedTime` = ?,`parentFolderPath` = ?,`coverArtPath` = ?,`duration` = ?,`durationInLong` = ?,`timeTitle` = ?,`id` = ? WHERE `id` = ?"
