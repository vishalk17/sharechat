...
.method public bridge synthetic bind(Ll6/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lsharechat/library/storage/dao/ContactDao_Impl$2;->bind(Ll6/f;Lsharechat/library/cvo/ContactEntity;)V
...
.method public bind(Ll6/f;Lsharechat/library/cvo/ContactEntity;)V
    ...
    .line 11
    :goto_2
    iget-object v0, p0, Lsharechat/library/storage/dao/ContactDao_Impl$2;->this$0:Lsharechat/library/storage/dao/ContactDao_Impl;
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `contacts` SET `id` = ?,`phoneNumber` = ?,`displayName` = ?,`syncStatus` = ?,`syncPacketId` = ?,`syncRequestTime` = ?,`isShareChatUser` = ?,`userId` = ?,`emailIds` = ?,`contactId` = ?,`rawContactId` = ?,`accountType` = ?,`accountName` = ?,`inviteTimestamp` = ? WHERE `id` = ?"
