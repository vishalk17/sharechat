...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lds/c$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lds/c$a;-><init>(Lkotlin/jvm/internal/h;)V
...
.method private final o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/x;
    .locals 1

    .line 1
    iget-object v0, p0, Lds/c;->g:Landroidx/recyclerview/widget/x;
    ...
    iput-object p1, p0, Lds/c;->g:Landroidx/recyclerview/widget/x;

    .line 3
    :cond_0
    iget-object p1, p0, Lds/c;->g:Landroidx/recyclerview/widget/x;
...
.method private final q(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/x;
    ...
    .line 1
    iget-object v0, p0, Lds/c;->f:Landroidx/recyclerview/widget/x;
    ...
    iput-object p1, p0, Lds/c;->f:Landroidx/recyclerview/widget/x;

    .line 3
    :cond_0
    iget-object p1, p0, Lds/c;->f:Landroidx/recyclerview/widget/x;

    return-object p1
.end method

.method private final t(Landroid/view/View;Landroidx/recyclerview/widget/x;)Ljava/lang/Integer;
    .locals 0
...
.method private final u(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/x;)Landroid/view/View;
    .locals 6
    ...
    .line 9
    :cond_6
    invoke-super {p0, p1}, Landroidx/recyclerview/widget/y;->h(Landroidx/recyclerview/widget/RecyclerView$p;)Landroid/view/View;
...
.method public b(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    .line 2
    new-instance v0, Lds/c$b;

    invoke-direct {v0, p0}, Lds/c$b;-><init>(Lds/c;)V
...
.method public c(Landroidx/recyclerview/widget/RecyclerView$p;Landroid/view/View;)[I
    ...
    .line 2
    invoke-direct {p0, p1}, Lds/c;->o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/x;

    move-result-object v1

    invoke-direct {p0, p2, v1}, Lds/c;->t(Landroid/view/View;Landroidx/recyclerview/widget/x;)Ljava/lang/Integer;
    ...
    .line 4
    invoke-direct {p0, p1}, Lds/c;->q(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/x;

    move-result-object p1

    invoke-direct {p0, p2, p1}, Lds/c;->t(Landroid/view/View;Landroidx/recyclerview/widget/x;)Ljava/lang/Integer;
...
.method public h(Landroidx/recyclerview/widget/RecyclerView$p;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Lds/c;->u(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/x;)Landroid/view/View;
